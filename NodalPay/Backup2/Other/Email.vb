...
Module Email
    ...
    '    'oAttch = Nothing
    'End Sub
    Friend Sub SendEmail(ByVal MailTO As String, ByVal Subject As String, ByVal Message As String, ByVal AttachmentFile As String, ByVal AttachmentName As String, ByVal AttachmentFile2 As String) ' Create an Outlook application.
