Public Class frmPrAnSocialInsCategories
    Dim tPrAnSocialInsCategories As New cPrAnSocialInsCategories
    Dim DG1Changing As Boolean = False
    Private Sub frmPrAnSocialInsCategories_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Top = 0
        Me.Left = 0
        Initialize()
        ...
        If Flag Then
            If Me.txtCode.Text <> "" Then
                If Not Me.txtCode.ReadOnly Then
                    Dim tPrAnSocialInsCategories As New cPrAnSocialInsCategories(Trim(Me.txtCode.Text))
                    If tPrAnSocialInsCategories.Code <> "" Then
                        MsgBox("Social Insurance Category already exists - Record  cannot be inserted", MsgBoxStyle.Critical)
                        Flag = False
                    End If
                End If
            End If
    ...
    Private Sub TSBNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSBNew.Click
        ...
        tPrAnSocialInsCategories = New cPrAnSocialInsCategories
        ClearMe()
        ClearErrors()
    ...
    End Sub
    '
    Private Sub LoadPrAnSocialInsCategories(ByVal tCode As String)
        tPrAnSocialInsCategories = New cPrAnSocialInsCategories(tCode)
        If tPrAnSocialInsCategories.Code <> "" Then
            With tPrAnSocialInsCategories
    ...
    Private Sub TSBDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TSBDelete.Click
        ...
        If Response = 1 Then
            If tPrAnSocialInsCategories.Delete(Trim(Me.txtCode.Text)) Then
