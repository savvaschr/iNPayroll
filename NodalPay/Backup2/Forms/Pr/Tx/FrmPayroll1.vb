...
Public Class FrmPayroll1
    ...
    Private Sub FrmPayroll1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            'GLBMaximumYear = Utils.Encrypt("2023")
...
#End Region
    ...
    Public Sub RunInterface(ByVal Reverse As Boolean)
        If Global1.GLB_OneInterfaceFile Then
            ...
            Dim i As Integer
            Dim ans As MsgBoxResult
            Str = "This Action will Create ONE Interface File for ALL Templates." & Chr(10) & _
    ...
    Private Sub PrintPayslips(ByVal SendToPrinter As Boolean, ByVal SendToEmail As Boolean, ByVal PrintCheques As Boolean, Optional ByVal Gmail As Boolean = False, Optional ByVal Office365 As Boolean = False, Optional ByVal SMTP As Boolean = False)
                    ...
                    If Not DoNotPrint Then
                        If Status = "POST" Or Status = "CALC" Then
                            If Selected = "1" Then
                                ...
                                CType(Me.ArCalculations(i), FrmPrTxCalculatePayroll).PrintPayslip(SendToPrinter, SendToEmail, PrintCheques, Gmail, Office365:=Office365, StrYear:=strYear, SMTP:=SMTP, Useemail2:=UseEmail2)
