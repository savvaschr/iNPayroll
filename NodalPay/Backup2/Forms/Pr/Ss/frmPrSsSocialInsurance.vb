Public Class frmPrSsSocialInsurance
    Dim tPrSsSocialInsurance As New cPrSsSocialInsurance
    Dim DG1Changing As Boolean = False
    Private Sub frmPrSsSocialInsurance_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Top = 0
        Me.Left = 0
        Initialize()
        ...
        If Flag Then
            If Me.txtCode.Text <> "" Then
                If Not Me.txtCode.ReadOnly Then
                    Dim tPrSsSocialInsurance As New cPrSsSocialInsurance(Trim(Me.txtCode.Text))
                    If tPrSsSocialInsurance.Code <> "" Then
                        MsgBox("Social Insurance already exists - Record cannot be inserted", MsgBoxStyle.Critical)
                        Flag = False
                    End If
                End If
            End If
    ...
    Private Sub TSBNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSBNew.Click
        ...
        tPrSsSocialInsurance = New cPrSsSocialInsurance
        ClearMe()
        ClearErrors()
    ...
    End Sub
    '
    Private Sub LoadPrSsSocialInsurance(ByVal tCode As String)
        tPrSsSocialInsurance = New cPrSsSocialInsurance(tCode)
        If tPrSsSocialInsurance.Code <> "" Then
            With tPrSsSocialInsurance
    ...
    Private Sub TSBDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TSBDelete.Click
        ...
        If Response = 1 Then
            If tPrSsSocialInsurance.Delete(Trim(Me.txtCode.Text)) Then
