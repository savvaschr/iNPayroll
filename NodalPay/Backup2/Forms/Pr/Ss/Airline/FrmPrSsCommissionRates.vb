Public Class FrmPrSsCommissionRates
    Dim tPrSsCommissionRates As New cPrSsCommissionRates
    Dim DG1Changing As Boolean = False
    Private Sub frmPrSsCommissionRates_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Top = 0
        Me.Left = 0
        Initialize()
        ...
        If Flag Then
            If Me.txtCode.Text <> "" Then
                If Not Me.txtCode.ReadOnly Then
                    Dim tPrSsCommissionRates As New cPrSsCommissionRates(Trim(Me.txtCode.Text))
                    If tPrSsCommissionRates.Code <> "" Then
                        MsgBox("Commission rate Fund already exists - Record cannot be inserted", MsgBoxStyle.Critical)
                        Flag = False
                    End If
                End If
            End If
    ...
    Private Sub TSBNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSBNew.Click
        ...
        tPrSsCommissionRates = New cPrSsCommissionRates
        ClearMe()
        ClearErrors()
    ...
    End Sub
    '
    Private Sub LoadPrSsCommissionRates(ByVal tCode As String)
        tPrSsCommissionRates = New cPrSsCommissionRates(tCode)
        If tPrSsCommissionRates.Code <> "" Then
            With tPrSsCommissionRates
    ...
    Private Sub TSBDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TSBDelete.Click
        ...
        If Response = 1 Then
            If tPrSsCommissionRates.Delete(Trim(Me.txtCode.Text)) Then
