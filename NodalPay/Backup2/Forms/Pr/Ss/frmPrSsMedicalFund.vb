Public Class frmPrSsMedicalFund
    Dim tPrSsMedicalFund As New cPrSsMedicalFund
    Dim DG1Changing As Boolean = False
    Private Sub frmPrSsMedicalFund_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Top = 0
        Me.Left = 0
        Initialize()
        ...
        If Flag Then
            If Me.txtCode.Text <> "" Then
                If Not Me.txtCode.ReadOnly Then
                    Dim tPrSsMedicalFund As New cPrSsMedicalFund(Trim(Me.txtCode.Text))
                    If tPrSsMedicalFund.Code <> "" Then
                        MsgBox("Medical Fund already exists - Record cannot be inserted", MsgBoxStyle.Critical)
                        Flag = False
                    End If
                End If
            End If
    ...
    Private Sub TSBNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSBNew.Click
        ...
        tPrSsMedicalFund = New cPrSsMedicalFund
        ClearMe()
        ClearErrors()
    ...
    End Sub
    '
    Private Sub LoadPrSsMedicalFund(ByVal tCode As String)
        tPrSsMedicalFund = New cPrSsMedicalFund(tCode)
        If tPrSsMedicalFund.Code <> "" Then
            With tPrSsMedicalFund
    ...
    Private Sub TSBDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TSBDelete.Click
        ...
        If Response = 1 Then
            If tPrSsMedicalFund.Delete(Trim(Me.txtCode.Text)) Then
