Public Class frmPrSsPayrollUnits
    Dim tPrSsPayrollUnits As New cPrSsPayrollUnits
    Dim DG1Changing As Boolean = False
    Private Sub frmPrSsPayrollUnits_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Top = 0
        Me.Left = 0
        Initialize()
        ...
        If Flag Then
            If Me.txtCode.Text <> "" Then
                If Not Me.txtCode.ReadOnly Then
                    Dim tPrSsPayrollUnits As New cPrSsPayrollUnits(Trim(Me.txtCode.Text))
                    If tPrSsPayrollUnits.Code <> "" Then
                        MsgBox("Payroll Unit already exists - Record cannot be inserted", MsgBoxStyle.Critical)
                        Flag = False
                    End If
                End If
            End If
    ...
    Private Sub TSBNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSBNew.Click
        ...
        tPrSsPayrollUnits = New cPrSsPayrollUnits
        ClearMe()
        ClearErrors()
    ...
    End Sub
    '
    Private Sub LoadPrSsPayrollUnits(ByVal tCode As String)
        tPrSsPayrollUnits = New cPrSsPayrollUnits(tCode)
        If tPrSsPayrollUnits.Code <> "" Then
            With tPrSsPayrollUnits
    ...
    Private Sub TSBDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TSBDelete.Click
        ...
        If Response = 1 Then
            If tPrSsPayrollUnits.Delete(Trim(Me.txtCode.Text)) Then
