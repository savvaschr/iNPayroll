Public Class frmPrSsContributionTypes
    Dim tPrSsContributionTypes As New cPrSsContributionTypes
    Dim DG1Changing As Boolean = False
    Private Sub frmPrSsContributionTypes_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Top = 0
        Me.Left = 0
        Initialize()
        ...
        If Flag Then
            If Me.txtCode.Text <> "" Then
                If Not Me.txtCode.ReadOnly Then
                    Dim tPrSsContributionTypes As New cPrSsContributionTypes(Trim(Me.txtCode.Text))
                    If tPrSsContributionTypes.Code <> "" Then
                        MsgBox("Contribution Type already exists - Record cannot be inserted", MsgBoxStyle.Critical)
                        Flag = False
                    End If
                End If
            End If
    ...
    Private Sub TSBNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSBNew.Click
        ...
        tPrSsContributionTypes = New cPrSsContributionTypes
        ClearMe()
        Me.txtSequence.Text = DG1.RowCount + 1
        ClearErrors()
    ...
    End Sub
    '
    Private Sub LoadPrSsContributionTypes(ByVal tCode As String)
        tPrSsContributionTypes = New cPrSsContributionTypes(tCode)
        If tPrSsContributionTypes.Code <> "" Then
            With tPrSsContributionTypes
    ...
    Private Sub TSBDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TSBDelete.Click
        ...
        If Response = 1 Then
            If tPrSsContributionTypes.Delete(Trim(Me.txtCode.Text)) Then
    ...
    Private Sub LoadDataFromDG1(ByVal i As Integer)
        ...
        If Me.DG1.RowCount > 0 Then
            ...
            Me.txtSequence.Text = DbNullToString(DG1.Item(3, i).Value)
            PKInputReadOnly(True)
        End If
    End Sub
