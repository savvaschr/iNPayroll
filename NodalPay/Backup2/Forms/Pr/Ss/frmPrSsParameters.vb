Public Class frmPrSsParameters
    Dim tPrSsParameters As New cPrSsParameters
    Dim DG1Changing As Boolean = False
    Private Sub frmPrSsParameters_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Top = 0
        Me.Left = 0
        Initialize()
        ...
        End If
        If Global1.GLBUserCode = "nodal" Then
            Me.TSBDelete.Enabled = True
        End If
        FillDG1()
        Me.CBSortBy.Checked = True
    End Sub
        ...
        If Flag Then
            If Me.txtId.Text <> "" Then
                If Not Me.txtId.ReadOnly Then
                    Dim tPrSsParameters As New cPrSsParameters(CInt(Trim(Me.txtId.Text)))
                    If tPrSsParameters.Id <> 0 Then
    ...
    Private Sub TSBNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSBNew.Click
        ...
        tPrSsParameters = New cPrSsParameters
        ClearMe()
        ClearErrors()
        ...
        If ValidateMe() Then
            ...
            Try
                ...
                With tPrSsParameters
                    ...
                    .System1 = CStr(Me.txtSystem1.Text)
    ...
    Private Sub LoadDataSetToExcel()
        ...
        ds = Global1.Business.AG_GetAllPrSsParameters(True)
        HeaderStr.Add("Id")
    ...
    End Sub
    '
    Private Sub LoadPrSsParameters(ByVal tId As Integer)
        tPrSsParameters = New cPrSsParameters(tId)
        If tPrSsParameters.Id <> 0 Then
            With tPrSsParameters
                ...
                Me.txtSystem1.Text = CStr(.System1)
    ...
    End Sub
    Private Sub FillDG1()
        Dim SortBySection As Boolean = False
        If CBSortBy.CheckState = CheckState.Checked Then
            SortbySection = True
        End If
        Dim ds As DataSet
        ds = Global1.Business.AG_GetAllPrSsParameters(SortBySection)
        DG1Changing = True
    ...
    Private Sub TSBDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TSBDelete.Click
        ...
        If Response = 1 Then
            If tPrSsParameters.Delete(CInt(Trim(Me.txtId.Text))) Then
    ...
    Private Sub LoadDataFromDG1(ByVal i As Integer)
        ...
        Me.txtSystem1.Text = DbNullToString(DG1.Item(5, i).Value)
    ...
    Private Sub CBSortBy_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CBSortBy.CheckedChanged
        FillDG1()
