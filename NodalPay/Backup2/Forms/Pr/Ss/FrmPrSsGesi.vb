Public Class FrmPrSsGesi

    Dim tPrSsGesi As New cPrSsGesi
    Dim DG1Changing As Boolean = False
    Private Sub frmPrSsGesi_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Top = 0
        Me.Left = 0
        Initialize()
        ...
        If Flag Then
            If Me.txtCode.Text <> "" Then
                If Not Me.txtCode.ReadOnly Then
                    Dim tPrSsGesi As New cPrSsGesi(Trim(Me.txtCode.Text))
                    If tPrSsGesi.Code <> "" Then
                        MsgBox("Gesi already exists - Record cannot be inserted", MsgBoxStyle.Critical)
                        Flag = False
                    End If
                End If
            End If
    ...
    End Sub
    '
    Private Sub LoadPrSsGesi(ByVal tCode As String)
        tPrSsGesi = New cPrSsGesi(tCode)
        If tPrSsGesi.Code <> "" Then
            With tPrSsGesi
    ...
    Private Sub TSBDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TSBDelete.Click
        ...
        If Response = 1 Then
            If tPrSsGesi.Delete(Trim(Me.txtCode.Text)) Then
