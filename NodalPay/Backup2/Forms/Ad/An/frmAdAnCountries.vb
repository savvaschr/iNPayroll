Public Class frmAdAnCountries
Dim tAdAnCountries As New cAdAnCountries
Dim DG1Changing as Boolean = False
Private Sub frmAdAnCountries_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Top = 0
        Me.Left = 0
        Initialize()
        ...
        If Flag Then
            If Me.txtCode.Text <> "" Then
                If Not Me.txtCode.ReadOnly Then
                    Dim tAdAnCountries As New cAdAnCountries(Trim(Me.txtCode.Text))
                    If tAdAnCountries.Code <> "" Then
                        MsgBox("Country already exists - Record cannot be inserted", MsgBoxStyle.Critical)
                        Flag = False
                    End If
                End If
            End If
    ...
    Private Sub TSBNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSBNew.Click
        ...
        tAdAnCountries = New cAdAnCountries
        ClearMe()
        ClearErrors()
    ...
    End Sub
    '
    Private Sub LoadAdAnCountries(ByVal tCode As String)
        tAdAnCountries = New cAdAnCountries(tCode)
        If tAdAnCountries.Code <> "" Then
            With tAdAnCountries
    ...
    Private Sub TSBDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TSBDelete.Click
        ...
        If Response = 1 Then
            If tAdAnCountries.Delete(Trim(Me.txtCode.Text)) Then
    ...
    Private Sub LoadDataFromDG1(ByVal i As Integer)
        ...
        If DG1.RowCount > 0 Then
            ...
            If DbNullToString(DG1.Item(2, i).Value) = "Y" Then
                Me.CBIsActive.Checked = True
            Else
                Me.CBIsActive.Checked = False
            End If
