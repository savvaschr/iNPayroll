...
'
'
Public Class cPrMsTemplateDeductions
    '
    Inherits cPrMsTemplateDeductionsDbTier
    '
    ...
    Public Sub New()
    End Sub
    Public Sub New(ByVal tTemplateGroupCode As String, ByVal tDeductionCode As String)
        Try
            Dim ds As DataSet
            ds = MyBase.GetByIndex(tTemplateGroupCode, tDeductionCode)
    ...
    Private Sub LoadDataRow(ByVal dr As DataRow)
        ...
        mDedCodCode = DbNullToString(dr.Item(2))
