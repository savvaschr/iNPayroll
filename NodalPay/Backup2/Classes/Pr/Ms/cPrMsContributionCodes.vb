...
'
'
Public Class cPrMsContributionCodes
    '
    Inherits cPrMsContributionCodesDbTier
    '
    Private mCode As String
    Private mConTypCode As String
    ...
    Public Property Code() As String
        ...
        End Set
    End Property
    Public Property ConTypCode() As String
        Get
            Return mConTypCode
        End Get
        Set(ByVal Value As String)
    ...
    Private Sub LoadDataRow(ByVal dr As DataRow)
        ...
        mConTypCode = DbNullToString(dr.Item(1))
