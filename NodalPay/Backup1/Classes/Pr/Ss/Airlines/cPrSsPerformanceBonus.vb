Public Class cPrSsPerformanceBonus
    Inherits cPrSsPerformanceBonusDBTier
    ...
    Private Sub LoadDataRow(ByVal dr As DataRow)
        ...
        mRate = DbNullToDouble(dr.Item(3))
        mType = DbNullToString(dr.Item(4))
        mFormula = DbNullToString(dr.Item(5))
