...
'
'
Public Class cPrMsDeductionCodes
    '
    Inherits cPrMsDeductionCodesDbTier
    '
    Private mCode As String
    Private mDedTypCode As String
    ...
    Public Property Code() As String
        ...
        End Set
    End Property
    Public Property DedTypCode() As String
        Get
            Return mDedTypCode
        End Get
        Set(ByVal Value As String)
    ...
    Private Sub LoadDataRow(ByVal dr As DataRow)
        ...
        mDedTypCode = DbNullToString(dr.Item(1))
