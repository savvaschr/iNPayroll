Public Class cPrMsDeductionsInterface
    Inherits cPrMsDeductionsInterfaceDBTier
    Private mId As Integer
    Private mIntTemCode As String
    Private mTemGrpCode As String
    Private mDedCode As String
    ...
    Public Sub New(ByVal tId As Integer)
        ...
        End If
    End Sub
    Public Sub New(ByVal tTemGrp_Code As String, ByVal tIntTem_Code As String, ByVal tDedCode As String)
        Dim ds As DataSet
        ds = MyBase.getbyPK(tTemGrp_Code, tIntTem_Code, tDedCode)
        If CheckDataSet(ds) Then
            LoadDataRow(ds.Tables(0).Rows(0))
        End If
    End Sub
    ...
    Private Sub LoadDataRow(ByVal dr As DataRow)
        ...
        mDedCode = DbNullToString(dr.Item(3))
