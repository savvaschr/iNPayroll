Public Class frmPrSsEarningTypes
    Dim tPrSsEarningTypes As New cPrSsEarningTypes
    Dim DG1Changing As Boolean = False
    Private Sub frmPrSsEarningTypes_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Top = 0
        Me.Left = 0
        Initialize()
        ...
        If Flag Then
            If Me.txtCode.Text <> "" Then
                If Not Me.txtCode.ReadOnly Then
                    Dim tPrSsEarningTypes As New cPrSsEarningTypes(Trim(Me.txtCode.Text))
                    If tPrSsEarningTypes.Code <> "" Then
                        MsgBox("Earning Type already exists - Record cannot be inserted", MsgBoxStyle.Critical)
                        Flag = False
                    End If
                End If
            End If
    ...
    Private Sub TSBNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSBNew.Click
        ...
        tPrSsEarningTypes = New cPrSsEarningTypes
        ClearMe()
    ...
    End Sub
    '
    Private Sub LoadPrSsEarningTypes(ByVal tCode As String)
        tPrSsEarningTypes = New cPrSsEarningTypes(tCode)
        If tPrSsEarningTypes.Code <> "" Then
            With tPrSsEarningTypes
    ...
    Private Sub TSBDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TSBDelete.Click
        ...
        If Response = 1 Then
            If tPrSsEarningTypes.Delete(Trim(Me.txtCode.Text)) Then
