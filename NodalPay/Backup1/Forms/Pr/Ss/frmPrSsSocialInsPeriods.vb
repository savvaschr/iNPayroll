Public Class frmPrSsSocialInsPeriods
    Dim tPrSsSocialInsPeriods As New cPrSsSocialInsPeriods
    Dim DG1Changing As Boolean = False
    Private Sub frmPrSsSocialInsPeriods_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Top = 0
        Me.Left = 0
        Initialize()
    ...
    Private Function ValidateMe() As Boolean
        ...
        Else
            If Not IsNumeric(Me.txtCode.Text) Then
                Flag = False
                Me.ErrCode.SetError(Me.txtCode, "Field requires a number")
            Else
                If NullToInt(Me.txtCode.Text) < 0 Then
                    Flag = False
                    Me.ErrCode.SetError(Me.txtCode, "Field requires positive number")
                End If
            End If
        End If
        ...
        If Flag Then
            If Me.txtCode.Text <> "" Then
                If Not Me.txtCode.ReadOnly Then
                    Dim tPrSsSocialInsPeriods As New cPrSsSocialInsPeriods(CInt(Trim(Me.txtCode.Text)))
                    If tPrSsSocialInsPeriods.Code <> 0 Then
                        MsgBox("Social Insurance Period already exists - Record cannot be inserted", MsgBoxStyle.Critical)
                        Flag = False
                    End If
                End If
            End If
    ...
    Private Sub TSBNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSBNew.Click
        ...
        tPrSsSocialInsPeriods = New cPrSsSocialInsPeriods
        ClearMe()
        ClearErrors()
    ...
    Private Sub TryToSave()
        If ValidateMe() Then
            ...
            Try
                ...
                '       Update = False
                '  End If
                With tPrSsSocialInsPeriods
                    .Code = NullToInt(Me.txtCode.Text)
    ...
    End Sub
    '
    Private Sub LoadPrSsSocialInsPeriods(ByVal tCode As Integer)
        tPrSsSocialInsPeriods = New cPrSsSocialInsPeriods(tCode)
        If tPrSsSocialInsPeriods.Code <> 0 Then
            With tPrSsSocialInsPeriods
    ...
    Private Sub TSBDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TSBDelete.Click
        ...
        If Response = 1 Then
            If tPrSsSocialInsPeriods.Delete(CInt(Trim(Me.txtCode.Text))) Then
