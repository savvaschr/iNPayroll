Public Class frmPrMsContributionCodes
    Dim tPrMsContributionCodes As New cPrMsContributionCodes
    Dim DG1Changing As Boolean = False
    Private Sub frmPrMsContributionCodes_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Top = 0
        Me.Left = 0
        Initialize()
        ...
        If Flag Then
            If Me.txtCode.Text <> "" Then
                If Not Me.txtCode.ReadOnly Then
                    Dim tPrMsContributionCodes As New cPrMsContributionCodes(Trim(Me.txtCode.Text))
                    If tPrMsContributionCodes.Code <> "" Then
                        MsgBox("Contribution Code already exists - Record cannot be inserted", MsgBoxStyle.Critical)
                        Flag = False
                    End If
                End If
            End If
    ...
    Private Sub ClearMe()
        Me.txtCode.Text = ""
        Try
            Me.cmbConTypCode.SelectedIndex = 0
    ...
    Private Sub LoadCombos()
        LoadPrSsContributionTypes()
    End Sub
    '
    Private Sub LoadPrSsContributionTypes()
        Dim ds As DataSet
        Dim i As Integer
        ds = Global1.Business.AG_GetAllPrSsContributionTypes()
        If CheckDataSet(ds) Then
            Dim tPrSsContributionTypes As New cPrSsContributionTypes
            With Me.cmbConTypCode
                .BeginUpdate()
                .Items.Clear()
                For i = 0 To ds.Tables(0).Rows.Count - 1
                    tPrSsContributionTypes = New cPrSsContributionTypes(DbNullToString(ds.Tables(0).Rows(i).Item(0)))
                    .Items.Add(tPrSsContributionTypes)
                Next i
                .ValueMember = "ConTyp_Code"
                .SelectedIndex = 0
                .EndUpdate()
            End With
        End If
    ...
    Private Sub ClearErrors()
        ...
        Me.ErrConTypCode.SetError(Me.cmbConTypCode, "")
    ...
    Private Sub TSBNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSBNew.Click
        ...
        tPrMsContributionCodes = New cPrMsContributionCodes
        ClearMe()
        ClearErrors()
    ...
    Private Sub TryToSave()
        If ValidateMe() Then
            ...
            Try
                ...
                '       Update = False
                '  End If
                With tPrMsContributionCodes
                    .Code = CStr(Me.txtCode.Text)
                    .ConTypCode = CType(Me.cmbConTypCode.SelectedItem, cPrSsContributionTypes).Code
    ...
    End Sub
    '
    Private Sub LoadPrMsContributionCodes(ByVal tCode As String)
        tPrMsContributionCodes = New cPrMsContributionCodes(tCode)
        If tPrMsContributionCodes.Code <> "" Then
            With tPrMsContributionCodes
                ...
                Dim ConTypCode As New cPrSsContributionTypes(.ConTypCode)
                Me.cmbConTypCode.SelectedIndex = Me.cmbConTypCode.FindStringExact(ConTypCode.ToString)
    ...
    Private Sub TSBDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TSBDelete.Click
        ...
        If Response = 1 Then
            If tPrMsContributionCodes.Delete(Trim(Me.txtCode.Text)) Then
    ...
    Private Sub LoadDataFromDG1(ByVal i As Integer)
        ...
        If Me.DG1.RowCount > 0 Then
            ...
            Dim ConTypCode As New cPrSsContributionTypes(Trim(CStr(DG1.Item(1, i).Value)))
            Me.cmbConTypCode.SelectedIndex = Me.cmbConTypCode.FindStringExact(ConTypCode.ToString)
