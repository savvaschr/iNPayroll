Public Class frmPrAnEmployeePositions
    Dim tPrAnEmployeePositions As New cPrAnEmployeePositions
    Dim DG1Changing As Boolean = False
    Private Sub frmPrAnEmployeePositions_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Top = 0
        Me.Left = 0
        Initialize()
        ...
        If Flag Then
            If Me.txtCode.Text <> "" Then
                If Not Me.txtCode.ReadOnly Then
                    Dim tPrAnEmployeePositions As New cPrAnEmployeePositions(Trim(Me.txtCode.Text))
                    If tPrAnEmployeePositions.Code <> "" Then
                        MsgBox("Position already exists - Record cannot be inserted", MsgBoxStyle.Critical)
                        Flag = False
                    End If
                End If
            End If
    ...
    Private Sub TSBNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSBNew.Click
        ...
        tPrAnEmployeePositions = New cPrAnEmployeePositions
        ClearMe()
        ClearErrors()
            ...
            Try
                ...
                With tPrAnEmployeePositions
                    ...
                    Else
                        .IsActive = "N"
                    End If
                    .Units = CStr(Me.txtReportUnits.Text)
                    If .Save() Then
    ...
    Private Sub LoadDataSetToExcel()
        ...
        ds = Global1.Business.AG_GetAllPrAnEmployeePositions(False)
        HeaderStr.Add("Code")
    ...
    End Sub
    '
    Private Sub LoadPrAnEmployeePositions(ByVal tCode As String)
        tPrAnEmployeePositions = New cPrAnEmployeePositions(tCode)
        If tPrAnEmployeePositions.Code <> "" Then
            With tPrAnEmployeePositions
    ...
    Private Sub TSBDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TSBDelete.Click
        ...
        If Response = 1 Then
            If tPrAnEmployeePositions.Delete(Trim(Me.txtCode.Text)) Then
    ...
    Private Sub LoadDataFromDG1(ByVal i As Integer)
        ...
        If Me.DG1.RowCount > 0 Then
            ...
            DbNullToString(DG1.Item(3, i).Value)
            If DbNullToString(DG1.Item(3, i).Value) = "Y" Then
                Me.CBIsActive.Checked = True
            Else
                Me.CBIsActive.Checked = False
            End If
            Me.txtReportUnits.Text = DbNullToString(DG1.Item(4, i).Value)
            PKInputReadOnly(True)
        End If
    End Sub
