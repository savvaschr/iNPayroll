Module Global1
    Public Version As String = "2.2025.006"
    'YTD Report
    'Sum Annual Units for 13nth
    'Open Next Year Period Automatically

    Public VersionDate As String = "26/09/2025"
    '14th Salary
    'Payslip directory
    ...
    Public PARAM_GLBAllMonthsPayslip As Boolean = False
    Public PARAM_GLBAllMonthsPayslipTOTALS As Boolean = False
    ...
    Public PARAM_AnalysisSortByDescription As Boolean = False

    Public PARAM_MFLimit As Double = 2.0
    Public PARAM_PFLimit As Double = 10.0

    Public Param_Exelsys As Boolean = False

    Public PARAM_SI_EDCCodes_ForReporting As String
    Public PARAM_TAX_EDCCodes_ForReporting As String
    Public PARAM_TAX_Code_ForReporting As String
    Public PARAM_NoCOLAOnArrears As Boolean = False
    Public PARAM_NonCompanyCostEarnings As String = ""
