Public Class FrmSearchBusPartner
    Public CalledBy As Integer
    Public ShowOnlyCustomer As Boolean = False
    Public ShowOnlySuplier As Boolean = False
    ...
    Private Sub SearchForCustomer(ByVal SearchCode As String, ByVal NextOrPrevius As Integer, ByVal PreviusSearchCode As String)
        ...
        Ds = Global1.Business.SearchForCustomer(Code, Description, Address, Phone, SearchCode, NextOrPrevius, PreviusSearchCode, ShowOnlyCustomer, ShowOnlySuplier)
    ...
    Private Sub DG1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DG1.DoubleClick
        If CheckDataSet(Ds) Then
            ...
            If i <= Ds.Tables(0).Rows.Count - 1 Then
                ...
                If CalledBy = 1 Then
                    'CType(Me.Owner, FrmTrxBooking).txtCustomerCode.Text = code
                    'CType(Me.Owner, FrmTrxBooking).txtCustomerDes.Text = Desc
                    'CType(Me.Owner, FrmTrxBooking).ToolTip1.SetToolTip(CType(Me.Owner, FrmTrxBooking).txtCustomerDes, Desc)
                ElseIf CalledBy = 2 Then
                    'CType(Me.Owner, FrmBusPartner).LoadMe(code)
                ElseIf CalledBy = 3 Then
                    CType(Me.Owner, FrmFiTrxnHeader).LoadBusinessPartner(code)
                ElseIf CalledBy = 4 Then
                    CType(Me.Owner, FrmAllocation).LoadBusinessPartner(code)
                End If
    ...
    Private Sub FrmSearchBusPartner_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        'Me.Top = 83
