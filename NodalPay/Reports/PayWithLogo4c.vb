...
Public Class PayWithLogo4c
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NodalPay.PayWithLogo4c.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPayWithLogo4c
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PayWithLogo4c = New PayWithLogo4c()
        rpt.Site = Me.Site
        Return rpt
    End Function
