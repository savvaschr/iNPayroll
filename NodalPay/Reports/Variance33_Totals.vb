...
Public Class Variance33_Totals
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NodalPay.Variance33_Totals.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVariance33_Totals
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Variance33_Totals = New Variance33_Totals()
        rpt.Site = Me.Site
        Return rpt
    End Function
