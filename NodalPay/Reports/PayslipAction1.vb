...
Public Class PayslipAction1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NodalPay.PayslipAction1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPayslipAction1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PayslipAction1 = New PayslipAction1()
        rpt.Site = Me.Site
        Return rpt
    End Function
