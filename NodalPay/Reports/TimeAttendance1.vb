...
Public Class TimeAttendance1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NodalPay.TimeAttendance1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTimeAttendance1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TimeAttendance1 = New TimeAttendance1()
        rpt.Site = Me.Site
        Return rpt
    End Function
