...
Public Class SINewEmployees
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NodalPay.SINewEmployees.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSINewEmployees
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SINewEmployees = New SINewEmployees()
        rpt.Site = Me.Site
        Return rpt
    End Function
