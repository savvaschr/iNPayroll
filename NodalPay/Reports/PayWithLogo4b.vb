...
Public Class PayWithLogo4b
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NodalPay.PayWithLogo4b.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPayWithLogo4b
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PayWithLogo4b = New PayWithLogo4b()
        rpt.Site = Me.Site
        Return rpt
    End Function
