...
Public Class SINewEmpReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NodalPay.SINewEmpReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSINewEmpReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SINewEmpReport = New SINewEmpReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
