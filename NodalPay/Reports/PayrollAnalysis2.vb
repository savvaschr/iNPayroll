...
Public Class PayrollAnalysis2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NodalPay.PayrollAnalysis2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPayrollAnalysis2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PayrollAnalysis2 = New PayrollAnalysis2()
        rpt.Site = Me.Site
        Return rpt
    End Function
