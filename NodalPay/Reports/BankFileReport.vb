...
Public Class BankFileReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NodalPay.BankFileReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBankFileReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BankFileReport = New BankFileReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
