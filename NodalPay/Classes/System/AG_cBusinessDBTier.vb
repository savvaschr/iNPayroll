...
Partial Public Class cBusinessDBTier
    ...
    Protected Function AG_GetAllPrAnBanks() As DataSet
        ...
        Return GetData(Str)
    End Function
    Protected Function AG_GetAllPrAnEmployeeAnalysis1(OnlyActive As Boolean) As DataSet
        Dim Str As String
        Dim Str2 As String = ""
        Dim Str1 As String = ""
        If OnlyActive Then
            Str1 = " Where EmpAn1_IsActive='Y' "
        End If
        Str = " SELECT " &
            " EmpAn1_Code," &
            " EmpAn1_DescriptionL," &
        ...
        If Global1.PARAM_AnalysisSortByDescription Then
            Str2 = " Order by EmpAn1_IsActive Desc,EmpAn1_DescriptionL Asc"
        Else
            Str2 = " Order by EmpAn1_IsActive Desc ,EmpAn1_Code Asc"
        End If
        Str = Str & Str1 & Str2
        Return GetData(Str)
    End Function
    Protected Function AG_GetAllPrAnEmployeeAnalysis2(OnlyActive As Boolean) As DataSet
        Dim Str As String
        Dim Str2 As String = ""
        Dim Str1 As String = ""
        If OnlyActive Then
            Str1 = " Where EmpAn2_IsActive='Y' "
        End If
        ...
        If Global1.PARAM_AnalysisSortByDescription Then
            Str2 = " Order by EmpAn2_IsActive Desc,EmpAn2_DescriptionL Asc"
        Else
            Str2 = " Order by EmpAn2_IsActive Desc,EmpAn2_Code Asc"
        End If
        Str = Str & Str1 & Str2

        Return GetData(Str)
    End Function
    Protected Function AG_GetAllPrAnEmployeeAnalysis3(OnlyActive As Boolean) As DataSet
        Dim Str As String
        Dim Str2 As String = ""
        Dim Str1 As String = ""
        If OnlyActive Then
            Str1 = " Where EmpAn3_IsActive='Y' "
        End If
        Str = " SELECT " &
            " EmpAn3_Code," &
            " EmpAn3_DescriptionL," &
        ...
        If Global1.PARAM_AnalysisSortByDescription Then
            Str2 = " Order by EmpAn3_IsActive Desc,EmpAn3_DescriptionL Asc"
        Else
            Str2 = " Order by EmpAn3_IsActive Desc,EmpAn3_Code Asc"
        End If
        Str = Str & Str1 & Str2

        Return GetData(Str)
    End Function
    Protected Function AG_GetAllPrAnEmployeeAnalysis4(OnlyActive As Boolean) As DataSet
        Dim Str As String
        Dim Str2 As String = ""
        Dim Str1 As String = ""
        If OnlyActive Then
            Str1 = " Where EmpAn4_IsActive='Y' "
        End If
        ...
        If Global1.PARAM_AnalysisSortByDescription Then
            Str2 = " Order by EmpAn4_IsActive Desc,EmpAn4_DescriptionL Asc"
        Else
            Str2 = " Order by EmpAn4_IsActive Desc,EmpAn4_Code Asc"
        End If
        Str = Str & Str1 & Str2

        Return GetData(Str)
    End Function
    Protected Function AG_GetAllPrAnEmployeeAnalysis5(OnlyActive As Boolean) As DataSet
        Dim Str As String
        Dim Str2 As String = ""

        Dim Str1 As String = ""
        If OnlyActive Then
            Str1 = " Where EmpAn5_IsActive='Y' "
        End If
        ...
        If Global1.PARAM_AnalysisSortByDescription Then
            Str2 = " Order by EmpAn5_IsActive Desc, EmpAn5_DescriptionL Asc"
        Else
            Str2 = " Order by EmpAn5_IsActive Desc, EmpAn5_Code Asc"
        End If
        Str = Str & Str1 & Str2
    ...
    Protected Function AG_GetAllPrAnEmployeePositions(ByVal SortByDesc As String) As DataSet
        ...
        If SortByDesc Then
            Str2 = " Order by EmpPos_IsActive Desc,EmpPos_DescriptionL Asc"
        Else
            Str2 = " Order by EmpPos_IsActive Desc"
        End If
    ...
    Protected Function GetAllEmployeesForExcelWithSalary(ByVal PeriodGroupCode As String, ByVal Showdiscounts As Boolean) As DataSet
        ...
        If Showdiscounts Then
            Str2 = " ,PrTxEmployeeDiscounts.EmpDis_Discount1, " &
            " PrTxEmployeeDiscounts.EmpDis_Discount2, " &
            " PrTxEmployeeDiscounts.EmpDis_Discount3, " &
            " PrTxEmployeeDiscounts.EmpDis_Discount4, " &
            " PrTxEmployeeDiscounts.EmpDis_Discount5, " &
            " PrTxEmployeeDiscounts.EmpDis_Discount6, " &
            " PrTxEmployeeDiscounts.EmpDis_Discount7,  " &
            " PrTxEmployeeDiscounts.EmpDis_Discount8, " &
            " PrTxEmployeeDiscounts.EmpDis_Discount9, " &
