Public Class cPrMsContributionsInterface
    Inherits cPrMsContributionsInterfaceDBTier
    Private mId As Integer
    Private mIntTemCode As String
    Private mTemGrpCode As String
    Private mConCode As String
    ...
    Public Property TemGrpCode() As String
        ...
        End Set
    End Property
    Public Property ConCode() As String
        Get
            Return mConCode
        End Get
        Set(ByVal value As String)
    ...
    Public Sub New(ByVal Dr As DataRow)
        ...
        End If
    End Sub
    Public Sub New(ByVal tTemGrp_Code As String, ByVal tIntTem_Code As String, ByVal tConCode As String)
        Dim ds As DataSet
        ds = MyBase.GetByPK(tTemGrp_Code, tIntTem_Code, tConCode)
        If CheckDataSet(ds) Then
            LoadDataRow(ds.Tables(0).Rows(0))
        End If
    End Sub
    Private Sub LoadDataRow(ByVal dr As DataRow)
        ...
        mConCode = DbNullToString(dr.Item(3))
