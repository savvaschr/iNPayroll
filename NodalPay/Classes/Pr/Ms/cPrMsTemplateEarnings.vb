...
'
'
Public Class cPrMsTemplateEarnings
    '
    Inherits cPrMsTemplateEarningsDbTier
    '
    ...
    End Sub
    Public Sub New(ByVal tTemplateGroupCode As String, ByVal tEarningCode As String)
        Try
            Dim ds As DataSet
            ds = MyBase.GetByIndex(tTemplateGroupCode, tEarningCode)
    ...
    Private Sub LoadDataRow(ByVal dr As DataRow)
        ...
        mErnCodCode = DbNullToString(dr.Item(2))
        ...
        mCalcFormula = DbNullToString(dr.Item(8))
