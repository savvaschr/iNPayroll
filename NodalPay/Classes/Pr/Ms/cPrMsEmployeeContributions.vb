...
'
'
Public Class cPrMsEmployeeContributions
    '
    Inherits cPrMsEmployeeContributionsDbTier
    '
    ...
    Public Sub New(ByVal tId As Integer)
        ...
        End If
    End Sub
    Public Sub New(ByVal tEmpCode As String, ByVal tConCode As String)
        Try
            Dim ds As DataSet
            ds = MyBase.GetByEmpCodeConCode(tEmpCode, tConCode)
    ...
    Private Sub LoadDataRow(ByVal dr As DataRow)
        ...
        mConCode = DbNullToString(dr.Item(2))
