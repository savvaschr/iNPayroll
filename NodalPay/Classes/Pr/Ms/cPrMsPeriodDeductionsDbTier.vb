...
'
'
Public Class cPrMsPeriodDeductionsDbTier
    '
    Inherits cDataTier
    '
    ...
    Protected Function GetByPK(ByVal tPerCode As String, ByVal tPerGroup As String, ByVal tEDCCode As String) As DataSet
        ...
        Str = " SELECT" & _
                ...
                " and DedCod_Code = " & enQuoteString(tEDCCode)

        Return MyBase.GetData(Str)
    End Function
   
    Protected Function Save(ByRef _cPrMsPeriodDeductions As cPrMsPeriodDeductions) As Boolean
        Dim SpParams As New ArrayList
        Dim SpNames As New ArrayList
        Dim Flag As Boolean = False
        With _cPrMsPeriodDeductions
            SpParams.Add(.Id)                                                '(0)
            SpNames.Add("PrdDed_id")                                         '(0)
            ...
            SpNames.Add("PrdDed_IsActive")                                   '(3)
        End With
        SpNames.Add("NewId")                                             '(4)
        SpParams.Add(CInt(0))                                            '(4)
        If Me.StoredProcedure("AG_PrMsPeriodDeductions_Save_Update", SpParams, SpNames, 5) Then
            If _cPrMsPeriodDeductions.Id = 0 Then
                _cPrMsPeriodDeductions.Id = DbNullToInt(SpParams(5))
            End If
            Return True
        Else
            Return False
