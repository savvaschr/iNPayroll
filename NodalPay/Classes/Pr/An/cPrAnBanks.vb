...
'
'
Public Class cPrAnBanks
    '
    Inherits cPrAnBanksDbTier
    '
    Private mCode As String
    Private mDescriptionL As String
    Private mDescriptionS As String
    Private mIsActive As String
    Private mTransferCode As String
    Private mSwiftCode As String
    ...
    Private Sub Init(ByVal tCode As String)
        ...
        End Try
    End Sub
    Public Sub New(ByVal tSwift As String, ByVal BySwiftCode As Boolean)
        Try
            If tSwift <> "" Then
                Dim ds As DataSet
                ds = MyBase.GetBySwift(tSwift)
                If CheckDataSet(ds) Then
                    LoadDataRow(ds.Tables(0).Rows(0))
                End If
            End If
    ...
    Private Sub LoadDataRow(ByVal dr As DataRow)
        ...
        mTransferCode = DbNullToString(dr.Item(4))
        mSwiftCode = DbNullToString(dr.Item(5))
    End Sub
