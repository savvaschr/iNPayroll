...
Public Class cPrTxEmployeeSalaryDbTier
    ...
    End Function
    Protected Function GetByValueDate(EmpCode As String, ByVal tSalaryValue As Double, effectivedate As Date) As DataSet
        Dim Str As String
        ...
        Str = " SELECT" &
                ...
                " EmpSal_RateSalary " &
            "  FROM PrTxEmployeeSalary" &
            "  WHERE EmpSal_Value = " & tSalaryValue &
            "  and EmpSal_effPayDate = " & enQuoteString(EffectDate) &
            "  and Emp_Code = " & enQuoteString(EmpCode)


        Return MyBase.GetData(Str)
    End Function
    Protected Function GetByValueDateNotSalary(EmpCode As String, effectivedate As Date) As DataSet
        Dim Str As String
        ...
        Str = " SELECT" &
                ...
                " EmpSal_RateSalary " &
            "  FROM PrTxEmployeeSalary" &
            "  WHERE EmpSal_effPayDate = " & enQuoteString(EffectDate) &
            "  and Emp_Code = " & enQuoteString(EmpCode)
