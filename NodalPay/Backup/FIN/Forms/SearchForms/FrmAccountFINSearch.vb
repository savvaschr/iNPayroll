Public Class FrmAccountFINSearch
    ...
    Private Sub SearchForCustomer(ByVal SearchCode As String, ByVal NextOrPrevius As Integer, ByVal PreviusSearchCode As String)
        ...
        '    CustomerOnly = True
        'End If
        Ds = Global1.Business.SearchForAccountFin(Code, Description, SearchCode, NextOrPrevius, PreviusSearchCode, True)
        ...
        If CheckDataSet(Ds) Then
            ...
            If i <= Ds.Tables(0).Rows.Count - 1 Then
                ...
                If Me.CalledBy = 1 Then
                    CType(Me.Owner, FrmTrxAccountLines).txtAccountCode.Text = code
                    CType(Me.Owner, FrmTrxAccountLines).FindAccount()
                ElseIf Me.CalledBy = 2 Then
                    CType(Me.Owner, FrmFiTrxnHeader).txtAccountCode.Text = code
                    CType(Me.Owner, FrmFiTrxnHeader).FindAccount()
                ElseIf Me.CalledBy = 3 Then
                    CType(Me.Owner, FrmBudget).LoadAccount(code, Desc, RowIndex)
                End If
    ...
    Private Sub FrmAccountFINSearch_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        'Dim OwnerTop As Integer
        'Dim OwnerLeft As Integer
        'OwnerTop = CType(Me.Owner, FrmTrxAccountLines).Top
        'OwnerLeft = CType(Me.Owner, FrmTrxAccountLines).Left

        'Me.Top = OwnerTop + Global1.TopMark
        'Me.Left = OwnerLeft + Global1.LeftMark
    ...
    Private Sub FrmAccountFINSearch_Move(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Move
