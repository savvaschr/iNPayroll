...
'
'
Public Class cPrMsEmployeeDeductions
    '
    Inherits cPrMsEmployeeDeductionsDbTier
    '
    ...
    Public Sub New(ByVal tId As Integer)
        ...
        End If
    End Sub
    Public Sub New(ByVal tEmpCode As String, ByVal tDedCode As String)
        Try
            Dim ds As DataSet
            ds = MyBase.GetByEmpCodeDedCode(tEmpCode, tDedCode)
    ...
    Private Sub LoadDataRow(ByVal dr As DataRow)
        ...
        mDedCode = DbNullToString(dr.Item(2))
