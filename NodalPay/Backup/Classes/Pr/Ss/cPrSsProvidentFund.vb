...
'
'
Public Class cPrSsProvidentFund
    '
    Inherits cPrSsProvidentFundDbTier
    '
    ...
    Public Property Limit() As Double
        ...
        End Set
    End Property
    Public Property NextCode() As String
        Get
            Return mNextCode
        End Get
        Set(ByVal value As String)
    ...
    Private Sub LoadDataRow(ByVal dr As DataRow)
        ...
        mLimit = DbNullToDouble(dr.Item(4))
        mNextCode = DbNullToString(dr.Item(5))
    End Sub
