Public Class cPrSsSocialCohesion
    Inherits cPrSsSocialCohesionDBTier
    '
    Private mCode As String
    Private mDesc As String
    Private mDedValue As Double
    Private mConValue As Double
    ...
    Public Property Desc() As String
        ...
        End Set
    End Property
    Public Property DedValue() As Double
        Get
            Return mDedValue
        End Get
        ...
        End Set
    End Property
    Public Property ConValue() As Double
        Get
            Return mConValue
        End Get
        Set(ByVal Value As Double)
    ...
    Private Sub LoadDataRow(ByVal dr As DataRow)
        ...
        mDedValue = DbNullToDouble(dr.Item(2))
        mConValue = DbNullToDouble(dr.Item(3))
    End Sub
