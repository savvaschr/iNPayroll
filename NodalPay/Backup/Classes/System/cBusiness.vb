...
#Region "Payroll"
    ...
    End Function
    Public Shadows Function GetSumOfAnuallUnitsFor(ByVal GLBCurrentPeriod As cPrMsPeriodCodes, ByVal EmployeeCode As String) As Double
        Return MyBase.GetSumOfAnuallUnitsFor(GLBCurrentPeriod, EmployeeCode)
    End Function
    ...
    End Function
    Public Shadows Function FindEmployeeOfUser(ByVal Code As String, ByVal NextEmp As Boolean, ByVal UserName As String, ByVal SameCode As Boolean) As DataSet
        Return MyBase.FindEmployeeOfUser(Code, NextEmp, UserName, SameCode)
    End Function
...
#End Region
    ...
    Public Shadows Function UpdateTrxnHeaderAnalysis(ByVal Analysis As String, ByVal HeaderID As Integer, ByVal Index As Integer)
        Return MyBase.UpdateTrxnHeaderAnalysis3(Analysis, HeaderID, Index)
    End Function
