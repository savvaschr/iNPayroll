...
Public Class PayrollAnalysis4
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NodalPay.PayrollAnalysis4.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPayrollAnalysis4
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PayrollAnalysis4 = New PayrollAnalysis4
        rpt.Site = Me.Site
        Return rpt
    End Function
