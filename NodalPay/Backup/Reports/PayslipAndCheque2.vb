...
Public Class PayslipAndCheque2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NodalPay.PayslipAndCheque2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPayslipAndCheque2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PayslipAndCheque2 = New PayslipAndCheque2
        rpt.Site = Me.Site
        Return rpt
    End Function
