...
Public Class SINewRegistration
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NodalPay.SINewRegistration.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSINewRegistration
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SINewRegistration = New SINewRegistration
        rpt.Site = Me.Site
        Return rpt
    End Function
