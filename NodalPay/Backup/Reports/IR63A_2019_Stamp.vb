...
Public Class IR63A_2019_Stamp
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NodalPay.IR63A_2019_Stamp.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedIR63A_2019_Stamp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As IR63A_2019_Stamp = New IR63A_2019_Stamp
        rpt.Site = Me.Site
        Return rpt
    End Function
