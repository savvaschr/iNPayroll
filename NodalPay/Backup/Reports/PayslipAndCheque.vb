...
Public Class PayslipAndCheque
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NodalPay.PayslipAndCheque.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPayslipAndCheque
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PayslipAndCheque = New PayslipAndCheque
        rpt.Site = Me.Site
        Return rpt
    End Function
