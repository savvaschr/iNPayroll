...
Public Class SIContributions
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NodalPay.SIContributions.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSIContributions
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SIContributions = New SIContributions
        rpt.Site = Me.Site
        Return rpt
    End Function
