...
Public Class SINewRegistration2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NodalPay.SINewRegistration2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSINewRegistration2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SINewRegistration2 = New SINewRegistration2
        rpt.Site = Me.Site
        Return rpt
    End Function
