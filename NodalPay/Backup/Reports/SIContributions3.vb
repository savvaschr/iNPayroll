...
Public Class SIContributions3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NodalPay.SIContributions3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSIContributions3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SIContributions3 = New SIContributions3
        rpt.Site = Me.Site
        Return rpt
    End Function
