...
Public Class SIContributions2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NodalPay.SIContributions2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSIContributions2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SIContributions2 = New SIContributions2
        rpt.Site = Me.Site
        Return rpt
    End Function
