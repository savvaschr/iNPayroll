...
Public Class PFReportWithLoan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NodalPay.PFReportWithLoan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPFReportWithLoan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PFReportWithLoan = New PFReportWithLoan
        rpt.Site = Me.Site
        Return rpt
    End Function
