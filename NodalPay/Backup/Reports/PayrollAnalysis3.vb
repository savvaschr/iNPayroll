...
Public Class PayrollAnalysis3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NodalPay.PayrollAnalysis3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPayrollAnalysis3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PayrollAnalysis3 = New PayrollAnalysis3
        rpt.Site = Me.Site
        Return rpt
    End Function
