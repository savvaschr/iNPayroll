...
Public Class OvertimeReport2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NodalPay.OvertimeReport2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOvertimeReport2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OvertimeReport2 = New OvertimeReport2
        rpt.Site = Me.Site
        Return rpt
    End Function
