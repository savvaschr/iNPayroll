Public Class FrmPrSsSocialCohesion
    Dim tPrSsSocialCohesion As New cPrSsSocialCohesion
    Dim DG1Changing As Boolean = False
    Private Sub frmPrSsSocialCohesion_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Top = 0
        Me.Left = 0
        Initialize()
        ...
        If Flag Then
            If Me.txtCode.Text <> "" Then
                If Not Me.txtCode.ReadOnly Then
                    Dim tPrSsSocialCohesion As New cPrSsSocialCohesion(Trim(Me.txtCode.Text))
                    If tPrSsSocialCohesion.Code <> "" Then
                        MsgBox("Social Cohesion already exists - Record cannot be inserted", MsgBoxStyle.Critical)
                        Flag = False
                    End If
                End If
            End If
    ...
    Private Sub TSBNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSBNew.Click
        ...
        tPrSsSocialCohesion = New cPrSsSocialCohesion
        ClearMe()
        ClearErrors()
    ...
    End Sub
    '
    Private Sub LoadPrSsSocialCohesion(ByVal tCode As String)
        tPrSsSocialCohesion = New cPrSsSocialCohesion(tCode)
        If tPrSsSocialCohesion.Code <> "" Then
            With tPrSsSocialCohesion
    ...
    Private Sub TSBDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TSBDelete.Click
        ...
        If Response = 1 Then
            If tPrSsSocialCohesion.Delete(Trim(Me.txtCode.Text)) Then
