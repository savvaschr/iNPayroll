Public Class FrmPrSsFlightHour
    Dim tPrSsFlighHour As New cPrSsFlightHours
    Dim DG1Changing As Boolean = False
    Private Sub frmPrSsFlightHour_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Top = 0
        Me.Left = 0
        Initialize()
        ...
        If Flag Then
            If Me.txtCode.Text <> "" Then
                If Not Me.txtCode.ReadOnly Then
                    Dim tPrSsFlighHour As New cPrSsFlightHours(Trim(Me.txtCode.Text))
                    If tPrSsFlighHour.Code <> "" Then
                        MsgBox("Flight Hour already exists - Record cannot be inserted", MsgBoxStyle.Critical)
                        Flag = False
                    End If
                End If
            End If
    ...
    Private Sub ClearMe()
        Me.txtCode.Text = ""
        Me.txtDesc.Text = ""
        Me.txtHourRate.Text = "0.00"
        Me.txtHourLimit.Text = "0.00"
    End Sub
    '
    ...
    Private Sub PutDecimalValidationOnTxts()
        AddHandler txtHourRate.KeyPress, AddressOf NumericKeyPress
        AddHandler txtHourRate.Leave, AddressOf NumericOnLeave
        AddHandler txtHourLimit.KeyPress, AddressOf NumericKeyPress
        AddHandler txtHourLimit.Leave, AddressOf NumericOnLeave
    End Sub
    '
    Private Sub ClearErrors()
        Me.ErrCode.SetError(Me.txtCode, "")
        Me.ErrDesc.SetError(Me.txtDesc, "")
        Me.ErrDedValue.SetError(Me.txtHourRate, "")
        Me.ErrConValue.SetError(Me.txtHourLimit, "")
    End Sub
    '
    Private Sub TSBNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSBNew.Click
        Me.TSBNew.Enabled = False
        Me.Cursor = Cursors.WaitCursor()
        tPrSsFlighHour = New cPrSsFlightHours
        ClearMe()
        ClearErrors()
        ...
        If ValidateMe() Then
            ...
            Try
                ...
                With tPrSsFlighHour
                    ...
                    .HourRate = CDbl(Me.txtHourRate.Text)
                    .Limit = CDbl(Me.txtHourLimit.Text)
                    .LimitCode = CStr(Me.txtLimitCode.Text)
                    If .Save() Then
    ...
    Private Sub LoadDataSetToExcel()
        ...
        HeaderStr.Add("HourRate")
        HeaderStr.Add("Limit")
        HeaderStr.Add("LimitCode")
        HeaderSize.Add(4)
        HeaderSize.Add(40)
        HeaderSize.Add(18)
        HeaderSize.Add(18)
    ...
    End Sub
    '
    Private Sub LoadPrSsFlighHour(ByVal tCode As String)
        tPrSsFlighHour = New cPrSsFlightHours(tCode)
        If tPrSsFlighHour.Code <> "" Then
            With tPrSsFlighHour
                ...
                Me.txtHourRate.Text = Format(.HourRate, "0.00")
                Me.txtHourLimit.Text = Format(.Limit, "0.00")
                Me.txtLimitCode.Text = CStr(.LimitCode)
    ...
    Private Sub TSBDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TSBDelete.Click
        ...
        If Response = 1 Then
            If tPrSsFlighHour.Delete(Trim(Me.txtCode.Text)) Then
    ...
    Private Sub LoadDataFromDG1(ByVal i As Integer)
        ...
        Me.txtHourRate.Text = DbNullToString(DG1.Item(2, i).Value)
        Me.txtHourLimit.Text = DbNullToString(DG1.Item(3, i).Value)
        PKInputReadOnly(True)
    End Sub
