Public Class FrmPrSsOverLay

    Dim tPrSsOverLay As New cPrSsOverLay
    Dim DG1Changing As Boolean = False
    Private Sub frmPrSsOverLay_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Top = 0
        Me.Left = 0
        Initialize()
        ...
        If Flag Then
            If Me.txtCode.Text <> "" Then
                If Not Me.txtCode.ReadOnly Then
                    Dim tPrSsOverLay As New cPrSsOverLay(Trim(Me.txtCode.Text))
                    If tPrSsOverLay.Code <> "" Then
                        MsgBox("Over Lay already exists - Record cannot be inserted", MsgBoxStyle.Critical)
                        Flag = False
                    End If
                End If
            End If
    ...
    End Sub
    '
    Private Sub LoadPrSsOverLay(ByVal tCode As String)
        tPrSsOverLay = New cPrSsOverLay(tCode)
        If tPrSsOverLay.Code <> "" Then
            With tPrSsOverLay
    ...
    Private Sub TSBDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TSBDelete.Click
        ...
        If Response = 1 Then
            If tPrSsOverLay.Delete(Trim(Me.txtCode.Text)) Then
