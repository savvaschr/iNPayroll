Public Class FrmPrSsExtraTaxTable
    Dim tPrSsTaxTable As New cPrSsExtraTaxTable
    ...
    Private Sub ClearMe()
        ...
        Me.txtTaxTbl_ConRate.Text = "0.00"
    ...
    Private Sub PutDecimalValidationOnTxts()
        ...
        AddHandler txtTaxTbl_ConRate.KeyPress, AddressOf NumericKeyPress
        AddHandler txtTaxTbl_ConRate.Leave, AddressOf NumericOnLeave
    End Sub
    '
    ...
    Private Sub TSBNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSBNew.Click
        ...
        tPrSsTaxTable = New cPrSsExtraTaxTable
        ClearMe()
        ClearErrors()
        ...
        If ValidateMe() Then
            ...
            Try
                ...
                With tPrSsTaxTable
                    ...
                    .TaxTbl_DedRate = CDbl(Me.txtTaxTbl_DedRate.Text)
                    .TaxTbl_ConRate = CDbl(Me.txtTaxTbl_ConRate.Text)
    ...
    Private Sub LoadPrSsTaxTable(ByVal tTaxTbl_id As Integer)
        tPrSsTaxTable = New cPrSsExtraTaxTable(tTaxTbl_id)
        If tPrSsTaxTable.TaxTbl_id <> 0 Then
            With tPrSsTaxTable
                ...
                Me.txtTaxTbl_DedRate.Text = Format(.TaxTbl_DedRate, "0.00")
                Me.txtTaxTbl_ConRate.Text = Format(.TaxTbl_ConRate, "0.00")
    ...
    Private Sub FillDG1()
        Dim ds As DataSet
        ds = Global1.Business.AG_GetAllPrSsExtraTaxTable()
        DG1Changing = True
    ...
    Private Sub LoadDataFromDG1(ByVal i As Integer)
        ...
        If Me.DG1.RowCount > 0 Then
            ...
            Me.txtTaxTbl_DedRate.Text = DbNullToString(DG1.Item(3, i).Value)
            Me.txtTaxTbl_ConRate.Text = DbNullToString(DG1.Item(4, i).Value)
