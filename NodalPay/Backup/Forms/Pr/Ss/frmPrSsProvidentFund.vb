Public Class frmPrSsProvidentFund
    Dim tPrSsProvidentFund As New cPrSsProvidentFund
    Dim DG1Changing As Boolean = False
    Private Sub frmPrSsProvidentFund_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Top = 0
        Me.Left = 0
        Initialize()
        ...
        If Flag Then
            If Me.txtCode.Text <> "" Then
                If Not Me.txtCode.ReadOnly Then
                    Dim tPrSsProvidentFund As New cPrSsProvidentFund(Trim(Me.txtCode.Text))
                    If tPrSsProvidentFund.Code <> "" Then
                        MsgBox("Provident Fund already exists - Record cannot be inserted", MsgBoxStyle.Critical)
                        Flag = False
                    End If
                End If
            End If
    ...
    Private Sub TSBNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSBNew.Click
        ...
        tPrSsProvidentFund = New cPrSsProvidentFund
        ClearMe()
        ClearErrors()
    ...
    End Sub
    '
    Private Sub LoadPrSsProvidentFund(ByVal tCode As String)
        tPrSsProvidentFund = New cPrSsProvidentFund(tCode)
        If tPrSsProvidentFund.Code <> "" Then
            With tPrSsProvidentFund
    ...
    Private Sub TSBDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TSBDelete.Click
        ...
        If Response = 1 Then
            If tPrSsProvidentFund.Delete(Trim(Me.txtCode.Text)) Then
    ...
    Private Sub LoadDataFromDG1(ByVal i As Integer)
        ...
        If Me.DG1.RowCount > 0 Then
            ...
            Me.txtLimit.Text = DbNullToString(DG1.Item(4, i).Value)
            Me.txtNewCode.Text = DbNullToString(DG1.Item(5, i).Value)
            PKInputReadOnly(True)
        End If
    End Sub
