Public Class frmPrSsDeductionTypes
    Dim tPrSsDeductionTypes As New cPrSsDeductionTypes
    Dim DG1Changing As Boolean = False
    Private Sub frmPrSsDeductionTypes_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Top = 0
        Me.Left = 0
        Initialize()
        ...
        If Flag Then
            If Me.txtCode.Text <> "" Then
                If Not Me.txtCode.ReadOnly Then
                    Dim tPrSsDeductionTypes As New cPrSsDeductionTypes(Trim(Me.txtCode.Text))
                    If tPrSsDeductionTypes.Code <> "" Then
                        MsgBox("Deduction Type already exists - Record cannot be inserted", MsgBoxStyle.Critical)
                        Flag = False
                    End If
                End If
            End If
    ...
    Private Sub TSBNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSBNew.Click
        ...
        tPrSsDeductionTypes = New cPrSsDeductionTypes
        ClearMe()
    ...
    End Sub
    '
    Private Sub LoadPrSsDeductionTypes(ByVal tCode As String)
        tPrSsDeductionTypes = New cPrSsDeductionTypes(tCode)
        If tPrSsDeductionTypes.Code <> "" Then
            With tPrSsDeductionTypes
    ...
    Private Sub TSBDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TSBDelete.Click
        ...
        If Response = 1 Then
            If tPrSsDeductionTypes.Delete(Trim(Me.txtCode.Text)) Then
