Public Class frmPrAnEmployeeCommunity
    Dim tPrAnEmployeeCommunity As New cPrAnEmployeeCommunity
    Dim DG1Changing As Boolean = False
    Private Sub frmPrAnEmployeeCommunity_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Top = 0
        Me.Left = 0
        Initialize()
        ...
        If Flag Then
            If Me.txtCode.Text <> "" Then
                If Not Me.txtCode.ReadOnly Then
                    Dim tPrAnEmployeeCommunity As New cPrAnEmployeeCommunity(Trim(Me.txtCode.Text))
                    If tPrAnEmployeeCommunity.Code <> "" Then
                        MsgBox("Community already exists - Record cannot be inserted", MsgBoxStyle.Critical)
                        Flag = False
                    End If
                End If
            End If
    ...
    Private Sub TSBNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSBNew.Click
        ...
        tPrAnEmployeeCommunity = New cPrAnEmployeeCommunity
        ClearMe()
        ClearErrors()
    ...
    End Sub
    '
    Private Sub LoadPrAnEmployeeCommunity(ByVal tCode As String)
        tPrAnEmployeeCommunity = New cPrAnEmployeeCommunity(tCode)
        If tPrAnEmployeeCommunity.Code <> "" Then
            With tPrAnEmployeeCommunity
    ...
    Private Sub TSBDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TSBDelete.Click
        ...
        If Response = 1 Then
            If tPrAnEmployeeCommunity.Delete(Trim(Me.txtCode.Text)) Then
