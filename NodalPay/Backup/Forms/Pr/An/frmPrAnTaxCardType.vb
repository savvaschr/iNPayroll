Public Class frmPrAnTaxCardType
    Dim tPrAnTaxCardType As New cPrAnTaxCardType
    Dim DG1Changing As Boolean = False
    Private Sub frmPrAnTaxCardType_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Top = 0
        Me.Left = 0
        Initialize()
        ...
        If Flag Then
            If Me.txtCode.Text <> "" Then
                If Not Me.txtCode.ReadOnly Then
                    Dim tPrAnTaxCardType As New cPrAnTaxCardType(Trim(Me.txtCode.Text))
                    If tPrAnTaxCardType.Code <> "" Then
                        MsgBox("Tax Card Type already exists - Record  cannot be inserted", MsgBoxStyle.Critical)
                        Flag = False
                    End If
                End If
            End If
    ...
    Private Sub TSBNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSBNew.Click
        ...
        tPrAnTaxCardType = New cPrAnTaxCardType
        ClearMe()
        ClearErrors()
    ...
    Private Sub LoadDataSetToExcel()
        ...
        ds = Global1.Business.AG_GetAllPrAnTaxCardType()
        HeaderStr.Add("Code")
    ...
    End Sub
    '
    Private Sub LoadPrAnTaxCardType(ByVal tCode As String)
        tPrAnTaxCardType = New cPrAnTaxCardType(tCode)
        If tPrAnTaxCardType.Code <> "" Then
            With tPrAnTaxCardType
    ...
    Private Sub TSBDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TSBDelete.Click
        ...
        If Response = 1 Then
            If tPrAnTaxCardType.Delete(Trim(Me.txtCode.Text)) Then
