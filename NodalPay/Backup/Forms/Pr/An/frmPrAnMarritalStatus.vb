Public Class frmPrAnMarritalStatus
    Dim tPrAnMarritalStatus As New cPrAnMarritalStatus
    Dim DG1Changing As Boolean = False
    Private Sub frmPrAnMarritalStatus_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Top = 0
        Me.Left = 0
        Initialize()
        ...
        If Flag Then
            If Me.txtCode.Text <> "" Then
                If Not Me.txtCode.ReadOnly Then
                    Dim tPrAnMarritalStatus As New cPrAnMarritalStatus(Trim(Me.txtCode.Text))
                    If tPrAnMarritalStatus.Code <> "" Then
                        MsgBox("Marrital Status already exists - Record cannot be inserted", MsgBoxStyle.Critical)
                        Flag = False
                    End If
                End If
            End If
    ...
    Private Sub TSBNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSBNew.Click
        ...
        tPrAnMarritalStatus = New cPrAnMarritalStatus
        ClearMe()
        ClearErrors()
    ...
    End Sub
    '
    Private Sub LoadPrAnMarritalStatus(ByVal tCode As String)
        tPrAnMarritalStatus = New cPrAnMarritalStatus(tCode)
        If tPrAnMarritalStatus.Code <> "" Then
            With tPrAnMarritalStatus
    ...
    Private Sub TSBDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TSBDelete.Click
        ...
        If Response = 1 Then
            If tPrAnMarritalStatus.Delete(Trim(Me.txtCode.Text)) Then
