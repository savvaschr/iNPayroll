Public Class frmPrAnEmploymentStatus
    Dim tPrAnEmploymentStatus As New cPrAnEmploymentStatus
    Dim DG1Changing As Boolean = False
    Private Sub frmPrAnEmploymentStatus_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Top = 0
        Me.Left = 0
        Initialize()
        ...
        If Flag Then
            If Me.txtCode.Text <> "" Then
                If Not Me.txtCode.ReadOnly Then
                    Dim tPrAnEmploymentStatus As New cPrAnEmploymentStatus(Trim(Me.txtCode.Text))
                    If tPrAnEmploymentStatus.Code <> "" Then
                        MsgBox("Status already exists - Record cannot be inserted", MsgBoxStyle.Critical)
                        Flag = False
                    End If
                End If
            End If
    ...
    Private Sub TSBNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSBNew.Click
        ...
        tPrAnEmploymentStatus = New cPrAnEmploymentStatus
        ClearMe()
        ClearErrors()
    ...
    End Sub
    '
    Private Sub LoadPrAnEmploymentStatus(ByVal tCode As String)
        tPrAnEmploymentStatus = New cPrAnEmploymentStatus(tCode)
        If tPrAnEmploymentStatus.Code <> "" Then
            With tPrAnEmploymentStatus
    ...
    Private Sub TSBDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TSBDelete.Click
        ...
        If Response = 1 Then
            If tPrAnEmploymentStatus.Delete(Trim(Me.txtCode.Text)) Then
