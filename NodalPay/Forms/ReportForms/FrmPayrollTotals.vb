Public Class FrmPayrollTotalsX
    ...
    End Sub
    Private Sub InitDataTable_7()

        dt7 = New DataTable("Table1")
        '0
        dt7.Columns.Add("EmpCode", System.Type.GetType("System.String"))
        '1
        dt7.Columns.Add("EmpName", System.Type.GetType("System.String"))
        '2
        dt7.Columns.Add("ActualUnits", System.Type.GetType("System.Double"))
        '3
        dt7.Columns.Add("EDC1", System.Type.GetType("System.String"))
        '4
        dt7.Columns.Add("EDCVal1", System.Type.GetType("System.Double"))
        '5
        dt7.Columns.Add("EDC2", System.Type.GetType("System.String"))
        '6
        dt7.Columns.Add("EDCVal2", System.Type.GetType("System.Double"))
        '7
        dt7.Columns.Add("EDC3", System.Type.GetType("System.String"))
        '8
        dt7.Columns.Add("EDCVal3", System.Type.GetType("System.Double"))
        '9
        dt7.Columns.Add("EDC4", System.Type.GetType("System.String"))
        '10
        dt7.Columns.Add("EDCVal4", System.Type.GetType("System.Double"))
        '11
        dt7.Columns.Add("EDC5", System.Type.GetType("System.String"))
        '12
        dt7.Columns.Add("EDCVal5", System.Type.GetType("System.Double"))
        '13
        dt7.Columns.Add("EDC6", System.Type.GetType("System.String"))
        '14
        dt7.Columns.Add("EDCVal6", System.Type.GetType("System.Double"))
        '15
        dt7.Columns.Add("Description1", System.Type.GetType("System.String"))
        '16
        dt7.Columns.Add("Description2", System.Type.GetType("System.String"))
    ...
    Private Sub LoadHeaderOfReport(ByVal DsHeader As DataSet, ByVal Per As cPrMsPeriodCodes, ByVal IncludeTotals As Boolean)
        ...
        If CheckDataSet(DsHeader) Then
            ...
            For i = 0 To DsHeader.Tables(0).Rows.Count - 1
                ...
                Dim Cd As Integer = 0
                Dim Cc As Integer = 0
                Dim DeductFromcompanycost As Double = 0
                '------------------------------------------------------------------
                'Earnings
                '------------------------------------------------------------------
                C1 = 0
                ...
                If CheckDataSet(DsP_Ern) Then
                    For Ei = 0 To DsP_Ern.Tables(0).Rows.Count - 1
                        ...
                        If Not NotInclude Then
                            TotalE = TotalE + ErnValue
                        End If
                        If erningisanoncompanycost(ErnCode) Then
                            DeductFromcompanycost = DeductFromcompanycost + ErnValue
                        End If
                        r(Me.Column_EV1 + Ce) = Format(ErnValue, "0.00")
                        ChangeColumnName(ErnDesc, Column_EV1 + Ce, "E")
                        Ce = Ce + 2
                ...
                If CheckDataSet(DsP_Con) Then
                    ...
                    r(Column_CVTotal) = Format(TotalC, "0.00")
                End If
                r(Column_CompanyCost) = Format(TotalE + TotalC - DeductFromcompanycost, "0.00")
                r(Column_SITotal) = Format((SIConTotal + SIDedTotal), "0.00")
                If Not YTDReport Then
                    r(Column_ChequeNo) = Reference
                Else
    ...
    End Sub
    Private Function ErningIsANonCompanyCost(ECode As String) As Boolean
        Dim F As Boolean = False
        Dim Ar() As String
        Dim i As Integer
        If PARAM_NonCompanyCostEarnings <> "" Then
            Ar = Global1.PARAM_NonCompanyCostEarnings.split("|")
    ...
    Private Sub PrepareReport_Differences2(ByVal PrevYear As Boolean)
        ...
        If CheckDataSet(DsEmp) Then '0
            ...
            For i = 0 To DsEmp.Tables(0).Rows.Count - 1
                ...
                If L1counter >= L2counter Then '1
                    If CheckDataSet(DsL1) Then '2
    ...
    Private Sub mnuTemplatePayslip_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuTemplatePayslip.Click
        ...
        If CheckDataSet(MyDs) Then
            ...
            If MyDs2.Tables.Count > 0 Then
                ...
                'Utils.WriteSchemaWithXmlTextWriter(MyDs2, "C:\Users\Admin\Documents\Visual Studio 2015\Projects\NodalPay - 2019\XML\Paysliptotals")
    ...
    End Function
    Public Function ReturnFromselectionEDC_SIX(ByVal DSx As DataSet, ByVal ArE() As Integer, ByVal ArD() As Integer, ByVal ArC() As Integer, ReportDesc1 As String, ReportDesc2 As String)
        Dim i As Integer
        Dim C1 As Integer = 0
        Dim C2 As Integer = 0
        Dim k As Integer
        ...
        If CheckDataSet(DSx) Then
            ...
            For i = 0 To DSx.Tables(0).Rows.Count - 1
                ...
                Dim r As DataRow = dt7.NewRow()

                Dim ArStr(6) As String
                Dim ArVal(6) As Double
                ...
                For k = 0 To 15
                    If ArE(k) <> 0 Then
                        ArStr(MyC) = DbNullToString(DSx.Tables(0).Rows(i).Item(ArE(k)))
                        ArVal(MyC) = DbNullToDouble(DSx.Tables(0).Rows(i).Item(ArE(k) + 1))
                        MyC = MyC + 1
                    End If
                Next
                '------------------------------------------------------------------
                ...
                For k = 0 To 15
                    If ArD(k) <> 0 Then
                        ArStr(MyC) = DbNullToString(DSx.Tables(0).Rows(i).Item(ArD(k)))
                        ArVal(MyC) = DbNullToDouble(DSx.Tables(0).Rows(i).Item(ArD(k) + 1))
                        MyC = MyC + 1
                    End If
                Next
                '------------------------------------------------------------------
                ...
                For k = 0 To 15
                    If ArC(k) <> 0 Then
                        ArStr(MyC) = DbNullToString(DSx.Tables(0).Rows(i).Item(ArC(k)))
                        ArVal(MyC) = DbNullToDouble(DSx.Tables(0).Rows(i).Item(ArC(k) + 1))
                        MyC = MyC + 1
                    End If
                Next
    ...
    Private Sub SelectTestToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SelectTestToolStripMenuItem.Click
        If CheckDataSet(MyDs) Then
            ...
            If CheckDataSet(MyDs7) Then
                ...
                r(4) = CompanyTotalCost
                MyDs7.Tables.Add(Dt3)


                Dim ReportToUse As String = "EDCReport2.rpt"



                ' Utils.WriteSchemaWithXmlTextWriter(MyDs2, "C:\Documents and Settings\user\My Documents\Visual Studio 2005\Projects\NodalPay\NodalPay\XML\PayrollAnal")
               ' Utils.WriteSchemaWithXmlTextWriter(MyDs7, "C:\Users\Admin\Documents\Visual Studio 2015\Projects\NodalPay - 2019\XML\EDCReport2")
                Utils.ShowReport(ReportToUse, MyDs7, FrmReport, "", False, "", False, False, "", False)
            End If
        End If
        ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    ...
    End Sub
    Public Function ReturnFromselectionEDC_2(ByVal DSx As DataSet, ByVal ArE() As Integer, ByVal ArD() As Integer, ByVal ArC() As Integer)
        Dim i As Integer
        Dim C1 As Integer = 0
        Dim C2 As Integer = 0
        Dim k As Integer
    ...
    End Sub
    Private Sub mnuPensionfund7_Click(sender As Object, e As EventArgs) Handles mnuPensionfund7.Click
        Dim PerFrom As cPrMsPeriodCodes
        ...
        'Per = CType(Me.CmbPeriod.SelectedItem, cPrMsPeriodCodes)
        GetPeriodEDC(PerFrom)
        DsHeader = Global1.Business.GetAllTrxnHeaderForPeriodForPensionFundReport7(PerFrom, EmpFrom, Empto, Analysis, AnalysisCode)
        ...
        If CheckDataSet(DsHeader) Then
            For i = 0 To DsHeader.Tables(0).Rows.Count - 1
                ...
                Arrears = Global1.Business.GetEarningCodeForHeader(HeaderId, "E2")

                PenFund = Global1.Business.GetDeductionCodeForHeader(HeaderId, "D18")
                WidowFund = Global1.Business.GetDeductionForHeader(HeaderId, "WO")
                C10 = Global1.Business.GetContributionCodeForHeader(HeaderId, "C12")

                Total = GrossSal + COLA + Arrears
                AddRecord = True
                If PenFund = 0 And WidowFund = 0 And C10 = 0 Then
                    AddRecord = False
                End If
                If AddRecord Then
                    ...
                    DsHeader.Tables(0).Rows(i).Item(10) = WidowFund
                    DsHeader.Tables(0).Rows(i).Item(11) = C10
                    DsHeader.Tables(0).Rows(i).Item(14) = Arrears
                    ...
                    r1(11) = DsHeader.Tables(0).Rows(i).Item(11)
                    r1(12) = DsHeader.Tables(0).Rows(i).Item(12)
                    r1(13) = DsHeader.Tables(0).Rows(i).Item(14)
                    r1(14) = DsHeader.Tables(0).Rows(i).Item(14)
                    r1(15) = DsHeader.Tables(0).Rows(i).Item(14)
        ...
        DsR.Tables(0).TableName = "Employee1"
        ...
        'Utils.WriteSchemaWithXmlTextWriter(DsR, "C:\Users\Administrator\Documents\Visual Studio 2005\Projects\NodalPay\NodalPay\XML\PenFundReport4")
        'Utils.WriteSchemaWithXmlTextWriter(DsR, "C:\Users\Admin\Documents\Visual Studio 2015\Projects\NodalPay - 2019\NodalPay\XML\tPenFundReport7")
        If CheckDataSet(DsHeader) Then
            Utils.ShowReport("PensionFund7.rpt", DsR, FrmReport, "", False)
        Else
            MsgBox("No records found to print.", MsgBoxStyle.Information)
        End If
    ...
    Private Sub ShowAsPayslipToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ShowAsPayslipToolStripMenuItem.Click
        ...
        If CheckDataSet(MyDsX) Then
            ...
            If MyDs3.Tables.Count > 0 Then
                ...
                Dim DsComp As New DataSet
                DsComp = Global1.Business.GetCompanyDetailsForShowTotalsAsPayslipReport(Company.Code)
                MyDs3.Tables.Add(DsComp.Tables(0).Copy)
                MyDs3.Tables(2).TableName = "Company"
                ...
                ' Utils.WriteSchemaWithXmlTextWriter(MyDs3, "C:\Users\Admin\Documents\Visual Studio 2015\Projects\NodalPay - 2019\XML\Paysliptotals")
