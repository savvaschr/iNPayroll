Public Class FrmEnableEDC
    Private Sub FrmEnableEDC_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        ans = MsgBox("This action will activate this EDC to all periods and Employees, Proceed? ", MsgBoxStyle.YesNoCancel)
    ...
    Private Sub RunUpdate(ByVal EDCType As String, ByVal EDCCode As String)
        ...
        If EDCCode <> "" Then
            CType(Me.Owner, FrmPrMsTemplateEDC).ActivateEDC(EDCCode, EDCType)
        Else
