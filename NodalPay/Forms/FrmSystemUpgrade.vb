Public Class FrmSystemUpgrade
    ...
    Private Sub Button58_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button58.Click
        ...
        Par.Type1 = "T"
        Par.System1 = "Y"
        Par.Description = "Allocation Status"
        If Par.Save() Then
            MsgBox("Set")
        Else
            MsgBox("Error")
    ...
    Private Sub Button59_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button59.Click
        Try
            ...
            With tPrSsLimits
                .Id = 0
                .EffectiveDate = CDate("2024/01/01")
                .Cola = CDbl(11.17)
                .InsurableWk = CDbl(1209)
                .InsurableMth = CDbl(5239)
                .InsurableAnnual = CDbl(62868)
                .DedContrAnnual = CDbl(11064.77)
                .IndAnnual = CDbl(314.34)
                .UnemAnnual = CDbl(754.42)
                .GesiD = CDbl(4770)
                .GesiC = CDbl(5220)
                If .Save() Then
                    MsgBox("Succesfull Limits Change for 2024", MsgBoxStyle.Information)
                Else
                    MsgBox("Unable to save Changes", MsgBoxStyle.Critical)
                End If
            End With
    ...
    Private Sub Button60_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button60.Click
        ...
        If Par.Id = 0 Then
            ...
            Par.Type1 = "T"
            Par.System1 = "Y"
            Par.Description = "Allocation Status 24"
            If Par.Save() Then
                MsgBox("Set")
            Else
                MsgBox("Error")
    ...
    Private Sub Button63_Click(sender As Object, e As EventArgs) Handles Button63.Click
        ...
        Par.Id = 0
        Par.Section = "EXLSys"
        Par.Item = "WebSPassword"
        Par.Value1 = "Demo$11"
        Par.Type1 = "T"
        Par.System1 = "N"
        Par.Description = "WebSPassword"
        If Not Par.Save() Then
            MsgBox("Error")
        End If
        ...
        Par.Id = 0
        Par.Section = "EXLSys"
        Par.Item = "WebSCompany"
        Par.Value1 = "ABC Co Ltd"
        Par.Type1 = "T"
        Par.System1 = "N"
        Par.Description = "WebSCompany"
        If Not Par.Save() Then
            MsgBox("Error")
        End If
        ...
        Par.Id = 0
        Par.Section = "EXLSys"
        Par.Item = "WebsEmpFillType"
        Par.Value1 = "Simple"
        Par.Type1 = "T"
        Par.System1 = "N"
        Par.Description = "WebSEmpFillType"
        If Not Par.Save() Then
            MsgBox("Error")
        End If
        ...
        'Par.Section = "EXLSys"
        'Par.Item = "WebURL"
        'Par.Value1 = "https://demo1wsi.exelsyslive.com/wsi/ExelsysWSI.asmx"
        'Par.Type1 = "T"
        'Par.System1 = "N"
        'Par.Description = "Web Service URL"
        'If Not Par.Save() Then
        '    MsgBox("Error")
        'End If
    ...
    Private Sub Button72_Click(sender As Object, e As EventArgs) Handles Button72.Click
        ...
        Par.Section = "EXLSys"
        Par.Item = "LastUpdate"
        Par.Value1 = "2024-01-01"
        Par.Type1 = "T"
        Par.System1 = "N"
        Par.Description = "Last Update"
        If Not Par.Save() Then
            MsgBox("Error")
        End If
        MsgBox("Done")
    ...
    Private Sub Button76_Click(sender As Object, e As EventArgs) Handles Button76.Click
        Try
            ...
            With tPrSsLimits
                .Id = 0
                .EffectiveDate = CDate("2025/01/01")
                .Cola = CDbl(12.56)
                .InsurableWk = CDbl(1281)
                .InsurableMth = CDbl(5551)
                .InsurableAnnual = CDbl(66612)
                .DedContrAnnual = CDbl(11723.71)
                .IndAnnual = CDbl(333.08)
                .UnemAnnual = CDbl(799.34)
                .GesiD = CDbl(4770)
                .GesiC = CDbl(5220)
                If .Save() Then
                    MsgBox("Succesfull Limits Change for 2025", MsgBoxStyle.Information)
                Else
                    MsgBox("Unable to save Changes", MsgBoxStyle.Critical)
                End If
            End With
    ...
    Private Sub Button77_Click(sender As Object, e As EventArgs) Handles Button77.Click
        ...
        If Par.Id = 0 Then
            ...
            Par.Type1 = "T"
            Par.System1 = "Y"
            Par.Description = "Allocation Status 25"
            If Par.Save() Then
        ...
        Dim Par2 As New cPrSsParameters("IT", "AllowNegative")
        If Par2.Id = 0 Then
            Par2.Id = 0
            Par2.Section = "IT"
            Par2.Item = "AllowNegative"
            Par2.Value1 = "1"
            Par2.Type1 = "T"
            Par2.System1 = "Y"
