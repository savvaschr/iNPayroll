Public Class frmPrAnEmployeeAnalysis3
    Dim tPrAnEmployeeAnalysis3 As New cPrAnEmployeeAnalysis3
    Dim DG1Changing As Boolean = False
    Private Sub frmPrAnEmployeeAnalysis3_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Top = 0
        Me.Left = 0
        Initialize()
        ...
        If Flag Then
            If Me.txtCode.Text <> "" Then
                If Not Me.txtCode.ReadOnly Then
                    Dim tPrAnEmployeeAnalysis3 As New cPrAnEmployeeAnalysis3(Trim(Me.txtCode.Text))
                    If tPrAnEmployeeAnalysis3.Code <> "" Then
                        MsgBox("Analysis3 already exists - Record cannot be inserted", MsgBoxStyle.Critical)
                        Flag = False
                    End If
                End If
            End If
    ...
    Private Sub TSBNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSBNew.Click
        ...
        tPrAnEmployeeAnalysis3 = New cPrAnEmployeeAnalysis3
        ClearMe()
        ClearErrors()
    ...
    Private Sub TryToSave()
        If ValidateMe() Then
            ...
            Try
                ...
                '    DsEmp = Global1.Business.CheckIfThisAnalysisIsUsed(CStr(Me.txtCode.Text), 3)
    ...
    End Sub
    '
    Private Sub LoadPrAnEmployeeAnalysis3(ByVal tCode As String)
        tPrAnEmployeeAnalysis3 = New cPrAnEmployeeAnalysis3(tCode)
        If tPrAnEmployeeAnalysis3.Code <> "" Then
            With tPrAnEmployeeAnalysis3
    ...
    Private Sub TSBDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TSBDelete.Click
        ...
        If Response = 1 Then
            If tPrAnEmployeeAnalysis3.Delete(Trim(Me.txtCode.Text)) Then
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Dim Y As String
        Do While S = True
            Dim T As New cPrAnEmployeeAnalysis3
            If c2 = 16 Then
                c1 = c1 + 1
                c2 = 0
                If c1 = 17 Then Exit Do
            End If
            c2 = c2 + 1

            With T
                X = c1.ToString.PadLeft(2, "0")
                Y = c2.ToString.PadLeft(2, "0")
                .Code = "A" & X & "-" & Y
                .DescriptionL = .Code
                .DescriptionS = .Code
                .IsActive = "Y"
