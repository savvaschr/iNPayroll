Public Class frmPrAnEmployeeAnalysis4
    Dim tPrAnEmployeeAnalysis4 As New cPrAnEmployeeAnalysis4
    Dim DG1Changing As Boolean = False
    Private Sub frmPrAnEmployeeAnalysis4_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Top = 0
        Me.Left = 0
        Initialize()
        ...
        If Flag Then
            If Me.txtCode.Text <> "" Then
                If Not Me.txtCode.ReadOnly Then
                    Dim tPrAnEmployeeAnalysis4 As New cPrAnEmployeeAnalysis4(Trim(Me.txtCode.Text))
                    If tPrAnEmployeeAnalysis4.Code <> "" Then
                        MsgBox("Analysis4 already exists - Record cannot be inserted", MsgBoxStyle.Critical)
                        Flag = False
                    End If
                End If
            End If
    ...
    Private Sub TSBNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSBNew.Click
        ...
        tPrAnEmployeeAnalysis4 = New cPrAnEmployeeAnalysis4
        ClearMe()
        ClearErrors()
    ...
    Private Sub TryToSave()
        If ValidateMe() Then
            ...
            Try
                ...
                '    DsEmp = Global1.Business.CheckIfThisAnalysisIsUsed(CStr(Me.txtCode.Text), 4)
    ...
    End Sub
    '
    Private Sub LoadPrAnEmployeeAnalysis4(ByVal tCode As String)
        tPrAnEmployeeAnalysis4 = New cPrAnEmployeeAnalysis4(tCode)
        If tPrAnEmployeeAnalysis4.Code <> "" Then
            With tPrAnEmployeeAnalysis4
    ...
    Private Sub TSBDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TSBDelete.Click
        ...
        If Response = 1 Then
            If tPrAnEmployeeAnalysis4.Delete(Trim(Me.txtCode.Text)) Then
    ...
    Private Sub LoadDataFromDG1(ByVal i As Integer)
        ...
        If DG1.RowCount > 0 Then
            ...
            Else
                Me.CBIsActive.Checked = False
            End If
            Me.txtGLAnal1.Text = DbNullToString(DG1.Item(4, i).Value, False)
            Me.txtGLAnal2.Text = DbNullToString(DG1.Item(5, i).Value, False)
