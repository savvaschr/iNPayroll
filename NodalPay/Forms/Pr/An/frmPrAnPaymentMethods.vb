Public Class frmPrAnPaymentMethods
    Dim tPrAnPaymentMethods As New cPrAnPaymentMethods
    Dim DG1Changing As Boolean = False
    Private Sub frmPrAnPaymentMethods_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Top = 0
        Me.Left = 0
        Initialize()
        ...
        If Flag Then
            If Me.txtCode.Text <> "" Then
                If Not Me.txtCode.ReadOnly Then
                    Dim tPrAnPaymentMethods As New cPrAnPaymentMethods(Trim(Me.txtCode.Text))
                    If tPrAnPaymentMethods.Code <> "" Then
                        MsgBox("Payment method already exists - Record cannot be inserted", MsgBoxStyle.Critical)
                        Flag = False
                    End If
                End If
            End If
    ...
    Private Sub TSBNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSBNew.Click
        ...
        tPrAnPaymentMethods = New cPrAnPaymentMethods
        ClearMe()
        ClearErrors()
    ...
    End Sub
    '
    Private Sub LoadPrAnPaymentMethods(ByVal tCode As String)
        tPrAnPaymentMethods = New cPrAnPaymentMethods(tCode)
        If tPrAnPaymentMethods.Code <> "" Then
            With tPrAnPaymentMethods
    ...
    Private Sub TSBDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TSBDelete.Click
        ...
        If Response = 1 Then
            If tPrAnPaymentMethods.Delete(Trim(Me.txtCode.Text)) Then
