Public Class frmPrAnEmployeeAnalysis1
    Dim tPrAnEmployeeAnalysis1 As New cPrAnEmployeeAnalysis1
    Dim DG1Changing As Boolean = False
    Private Sub frmPrAnEmployeeAnalysis1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Top = 0
        Me.Left = 0
        Initialize()
        ...
        If Flag Then
            If Me.txtCode.Text <> "" Then
                If Not Me.txtCode.ReadOnly Then
                    Dim tPrAnEmployeeAnalysis1 As New cPrAnEmployeeAnalysis1(Trim(Me.txtCode.Text))
                    If tPrAnEmployeeAnalysis1.Code <> "" Then
                        MsgBox("Analysis 1 already exists - Record cannot be inserted", MsgBoxStyle.Critical)
                        Flag = False
                    End If
                End If
            End If
    ...
    Private Sub TSBNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSBNew.Click
        ...
        tPrAnEmployeeAnalysis1 = New cPrAnEmployeeAnalysis1
        ClearMe()
        ClearErrors()
    ...
    Private Sub TryToSave()
        If ValidateMe() Then
            ...
            Try
                ...
                '    DsEmp = Global1.Business.checkIfThisAnalysisIsUsed(CStr(Me.txtCode.Text), 1)
    ...
    End Sub
    '
    Private Sub LoadPrAnEmployeeAnalysis1(ByVal tCode As String)
        tPrAnEmployeeAnalysis1 = New cPrAnEmployeeAnalysis1(tCode)
        If tPrAnEmployeeAnalysis1.Code <> "" Then
            With tPrAnEmployeeAnalysis1
    ...
    Private Sub TSBDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TSBDelete.Click
        ...
        If Response = 1 Then
            If tPrAnEmployeeAnalysis1.Delete(Trim(Me.txtCode.Text)) Then
