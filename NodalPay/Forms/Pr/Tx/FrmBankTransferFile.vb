Public Class FrmBankTransferFile
    ...
    Private Sub BtnCreateKyribaExcelFile_Click(sender As Object, e As EventArgs) Handles BtnCreateKyribaExcelFile.Click
        Create_KyribaExcelFile()
    End Sub
    Private Sub Create_KyribaExcelFile()
        InitFile = True
        Dim Includeinactive As Boolean = False
        Dim EmployeeBankCode As String = ""
        ...
        If CheckDataSet(ds) Then
            ...
            'xlsWorkSheet.Cells(1, 1) = "Transaction code"
            'xlsWorkSheet.Cells(1, 2) = "Kyriba Reference"
            'xlsWorkSheet.Cells(1, 3) = "Debit Bank Account"
            'xlsWorkSheet.Cells(1, 4) = "Third party name"
            'xlsWorkSheet.Cells(1, 5) = "Third party corporate ID code"
            'xlsWorkSheet.Cells(1, 6) = "Third party identifier type"
            'xlsWorkSheet.Cells(1, 7) = "Third party Identifier value"
            'xlsWorkSheet.Cells(1, 8) = "Third party address 1"
            'xlsWorkSheet.Cells(1, 9) = "Third party address 2"
            'xlsWorkSheet.Cells(1, 10) = "Third party city"
            'xlsWorkSheet.Cells(1, 11) = "Third party zip"
            'xlsWorkSheet.Cells(1, 12) = "Third party province code"
            'xlsWorkSheet.Cells(1, 13) = "Third party country code"
            'xlsWorkSheet.Cells(1, 14) = "Third party bank name"
            'xlsWorkSheet.Cells(1, 15) = "Third party bank BIC Code"
            'xlsWorkSheet.Cells(1, 16) = "Third party bank identifier type"
            'xlsWorkSheet.Cells(1, 17) = "Third party bank identifier value"
            'xlsWorkSheet.Cells(1, 18) = "Third party bank address 1"
            'xlsWorkSheet.Cells(1, 19) = "Third party bank address 2"
            'xlsWorkSheet.Cells(1, 20) = "Third party bank city"
            'xlsWorkSheet.Cells(1, 21) = "Third party bank zip"
            'xlsWorkSheet.Cells(1, 22) = "Third party bank province code"
            'xlsWorkSheet.Cells(1, 23) = "Third party bank country code"
            'xlsWorkSheet.Cells(1, 24) = "Third party bank account currency"
            'xlsWorkSheet.Cells(1, 25) = "Third party bank bank Id type"
            'xlsWorkSheet.Cells(1, 26) = "Third party bank account Id 1"
            'xlsWorkSheet.Cells(1, 27) = "One-time third party account nature"
            'xlsWorkSheet.Cells(1, 28) = "Correspondent BIC"
            'xlsWorkSheet.Cells(1, 29) = "Correspondent Description"
            'xlsWorkSheet.Cells(1, 30) = "Correspondent country code"
            'xlsWorkSheet.Cells(1, 31) = "Correspondent identifier type"
            'xlsWorkSheet.Cells(1, 32) = "Correspondent identifier value"
            'xlsWorkSheet.Cells(1, 33) = "Correspondent account"
            'xlsWorkSheet.Cells(1, 34) = "Transaction currency"
            'xlsWorkSheet.Cells(1, 35) = "Transaction amount"
            'xlsWorkSheet.Cells(1, 36) = "Debit Account Amount (Counter value amount)"
            'xlsWorkSheet.Cells(1, 37) = "Currency rate"
            'xlsWorkSheet.Cells(1, 38) = "Transaction Date"
            'xlsWorkSheet.Cells(1, 39) = "Value Date"
            'xlsWorkSheet.Cells(1, 40) = "Budget code"
            'xlsWorkSheet.Cells(1, 41) = "Purpose"
            'xlsWorkSheet.Cells(1, 42) = "Reason 1 (Remittance information)"
            'xlsWorkSheet.Cells(1, 43) = "Reason 2"
            'xlsWorkSheet.Cells(1, 44) = "Reason 3"
            'xlsWorkSheet.Cells(1, 45) = "Reason 4"
            'xlsWorkSheet.Cells(1, 46) = "Fee assessment"
            'xlsWorkSheet.Cells(1, 47) = "Currency buy flag"
            'xlsWorkSheet.Cells(1, 48) = "Currency buy reference"
            'xlsWorkSheet.Cells(1, 49) = "Beneficiary reminder flag"
            'xlsWorkSheet.Cells(1, 50) = "Beneficiary reminder mode"
            'xlsWorkSheet.Cells(1, 51) = "Beneficiary reminder number"
            'xlsWorkSheet.Cells(1, 52) = "Free text 1"
            'xlsWorkSheet.Cells(1, 53) = "Free text 2"
            'xlsWorkSheet.Cells(1, 54) = "Free text 3 (Structured Payment Reference)"
            'xlsWorkSheet.Cells(1, 55) = "Transfer/Remittance identifier 1"
            'xlsWorkSheet.Cells(1, 56) = "Transfer/Remittance identifier 2"
            'xlsWorkSheet.Cells(1, 57) = "Correspondent BIC"
            'xlsWorkSheet.Cells(1, 58) = "Correspondent Description"
            'xlsWorkSheet.Cells(1, 59) = "Correspondent country code"
            'xlsWorkSheet.Cells(1, 60) = "Correspondent identifier type"
            'xlsWorkSheet.Cells(1, 61) = "Correspondent identifier value"
            'xlsWorkSheet.Cells(1, 62) = "Correspondent account"

            Header = "Transaction code" & Separator
            Header = Header & "Kyriba Reference" & Separator
            Header = Header & "Debit Bank Account" & Separator
            Header = Header & "Third party name" & Separator
            Header = Header & "Third party corporate ID code" & Separator
            Header = Header & "Third party identifier type" & Separator
            Header = Header & "Third party Identifier value" & Separator
            Header = Header & "Third party address 1" & Separator
            Header = Header & "Third party address 2" & Separator
            Header = Header & "Third party city" & Separator
            Header = Header & "Third party zip" & Separator
            Header = Header & "Third party province code" & Separator
            Header = Header & "Third party country code" & Separator
            Header = Header & "Third party bank name" & Separator
            Header = Header & "Third party bank BIC Code" & Separator
            Header = Header & "Third party bank identifier type" & Separator
            Header = Header & "Third party bank identifier value" & Separator
            Header = Header & "Third party bank address 1" & Separator
            Header = Header & "Third party bank address 2" & Separator
            Header = Header & "Third party bank city" & Separator
            Header = Header & "Third party bank zip" & Separator
            Header = Header & "Third party bank province code" & Separator
            Header = Header & "Third party bank country code" & Separator
            Header = Header & "Third party bank account currency" & Separator
            Header = Header & "Third party bank bank Id type" & Separator
            Header = Header & "Third party bank account Id 1" & Separator
            Header = Header & "One-time third party account nature" & Separator
            Header = Header & "Correspondent BIC" & Separator
            Header = Header & "Correspondent Description" & Separator
            Header = Header & "Correspondent country code" & Separator
            Header = Header & "Correspondent identifier type" & Separator
            Header = Header & "Correspondent identifier value" & Separator
            Header = Header & "Correspondent account" & Separator
            Header = Header & "Transaction currency" & Separator
            Header = Header & "Transaction amount" & Separator
            Header = Header & "Debit Account Amount (Counter value amount)" & Separator
            Header = Header & "Currency rate" & Separator
            Header = Header & "Transaction Date" & Separator
            Header = Header & "Value Date" & Separator
            Header = Header & "Budget code" & Separator
            Header = Header & "Purpose" & Separator
            Header = Header & "Reason 1 (Remittance information)" & Separator
            Header = Header & "Reason 2" & Separator
            Header = Header & "Reason 3" & Separator
            Header = Header & "Reason 4" & Separator
            Header = Header & "Fee assessment" & Separator
            Header = Header & "Currency buy flag" & Separator
            Header = Header & "Currency buy reference" & Separator
            Header = Header & "Beneficiary reminder flag" & Separator
            Header = Header & "Beneficiary reminder mode" & Separator
            Header = Header & "Beneficiary reminder number" & Separator
            Header = Header & "Free text 1" & Separator
            Header = Header & "Free text 2" & Separator
            Header = Header & "Free text 3 (Structured Payment Reference)" & Separator
            Header = Header & "Transfer/Remittance identifier 1" & Separator
            Header = Header & "Transfer/Remittance identifier 2" & Separator
            Header = Header & "Correspondent BIC" & Separator
            Header = Header & "Correspondent Description" & Separator
            Header = Header & "Correspondent country code" & Separator
            Header = Header & "Correspondent identifier type" & Separator
            Header = Header & "Correspondent identifier value" & Separator
            Header = Header & "Correspondent account"

            WriteToCSVFile_Kyriba(Header, "")
            ...
            For i = 0 To ds.Tables(0).Rows.Count - 1
                If DbNullToString(ds.Tables(0).Rows(i).Item(11)) = "1" Then
                    ...
                    'xlsWorkSheet.Cells(Counter, 1) = "SALA"
                    'xlsWorkSheet.Cells(Counter, 2) = ""
                    'xlsWorkSheet.Cells(Counter, 3) = CompanyBankAcc
                    'xlsWorkSheet.Cells(Counter, 4) = EmpName
                    'xlsWorkSheet.Cells(Counter, 5) = ""
                    ...
                    'xlsWorkSheet.Cells(Counter, 13) = BANKcountry
                    'xlsWorkSheet.Cells(Counter, 14) = ""
                    'xlsWorkSheet.Cells(Counter, 15) = ""
                    'xlsWorkSheet.Cells(Counter, 16) = ""
                    'xlsWorkSheet.Cells(Counter, 17) = ""
                    'xlsWorkSheet.Cells(Counter, 18) = ""
                    'xlsWorkSheet.Cells(Counter, 19) = ""
                    'xlsWorkSheet.Cells(Counter, 20) = ""
                    'xlsWorkSheet.Cells(Counter, 21) = ""
                    'xlsWorkSheet.Cells(Counter, 22) = ""
                    'xlsWorkSheet.Cells(Counter, 23) = BenCountry
                    'xlsWorkSheet.Cells(Counter, 24) = "EUR"
                    'xlsWorkSheet.Cells(Counter, 25) = "1"
                    'xlsWorkSheet.Cells(Counter, 26) = IBAN
                    'xlsWorkSheet.Cells(Counter, 27) = ""
                    'xlsWorkSheet.Cells(Counter, 28) = ""
                    'xlsWorkSheet.Cells(Counter, 29) = ""
                    'xlsWorkSheet.Cells(Counter, 30) = ""
                    'xlsWorkSheet.Cells(Counter, 31) = ""
                    'xlsWorkSheet.Cells(Counter, 32) = ""
                    'xlsWorkSheet.Cells(Counter, 33) = ""
                    'xlsWorkSheet.Cells(Counter, 34) = "EUR"
                    'xlsWorkSheet.Cells(Counter, 35) = Salary
                    'xlsWorkSheet.Cells(Counter, 36) = ""
                    'xlsWorkSheet.Cells(Counter, 37) = ""
                    'xlsWorkSheet.Cells(Counter, 38) = ExecutionDate
                    'xlsWorkSheet.Cells(Counter, 39) = ""
                    'xlsWorkSheet.Cells(Counter, 40) = ""
                    'xlsWorkSheet.Cells(Counter, 41) = ""
                    'xlsWorkSheet.Cells(Counter, 42) = "Salary of " & Period.DescriptionL
                    'xlsWorkSheet.Cells(Counter, 43) = ""
                    'xlsWorkSheet.Cells(Counter, 44) = ""
                    'xlsWorkSheet.Cells(Counter, 45) = ""
                    'xlsWorkSheet.Cells(Counter, 46) = ""
                    'xlsWorkSheet.Cells(Counter, 47) = ""
                    'xlsWorkSheet.Cells(Counter, 48) = ""
                    'xlsWorkSheet.Cells(Counter, 49) = ""
                    'xlsWorkSheet.Cells(Counter, 50) = ""
                    'xlsWorkSheet.Cells(Counter, 51) = ""
                    'xlsWorkSheet.Cells(Counter, 52) = ""
                    'xlsWorkSheet.Cells(Counter, 53) = ""
                    'xlsWorkSheet.Cells(Counter, 54) = ""
                    'xlsWorkSheet.Cells(Counter, 55) = ""
                    'xlsWorkSheet.Cells(Counter, 56) = ""
                    'xlsWorkSheet.Cells(Counter, 57) = ""
                    'xlsWorkSheet.Cells(Counter, 58) = ""
                    'xlsWorkSheet.Cells(Counter, 59) = ""
                    'xlsWorkSheet.Cells(Counter, 60) = ""
                    'xlsWorkSheet.Cells(Counter, 61) = ""
                    'xlsWorkSheet.Cells(Counter, 62) = ""

                    Line = "SALA" & Separator
                    Line = Line & "" & Separator
                    Line = Line & CompanyBankAcc & Separator
                    Line = Line & EmpName & Separator
                    Line = Line & "" & Separator
                    Line = Line & "" & Separator
                    Line = Line & "" & Separator
                    Line = Line & "" & Separator
                    ...
                    Line = Line & "" & Separator
                    Line = Line & "" & Separator
                    Line = Line & BANKcountry & Separator
                    Line = Line & "" & Separator
                    Line = Line & "" & Separator
                    Line = Line & "" & Separator
                    Line = Line & "" & Separator
                    ...
                    Line = Line & "" & Separator
                    Line = Line & "" & Separator
                    Line = Line & BenCountry & Separator
                    Line = Line & "EUR" & Separator
                    Line = Line & "1" & Separator
                    ...
                    Line = Line & "" & Separator
                    Line = Line & "EUR" & Separator
                    Line = Line & Salary & Separator
                    Line = Line & "" & Separator
                    Line = Line & "" & Separator
                    Line = Line & ExecutionDate & Separator
                    Line = Line & "" & Separator
                    Line = Line & "" & Separator
                    Line = Line & "" & Separator
                    Line = Line & "Salary of " & Period.DescriptionL & Separator
                    Line = Line & "" & Separator
                    Line = Line & "" & Separator
                    Line = Line & "" & Separator
                    Line = Line & "" & Separator
    ...
    End Sub
    Private Function WriteToCSVFile_Kyriba(ByVal Line As String, ByVal fName As String) As Boolean
        Dim Flag As Boolean = True
        Try
            ' Dim mFile As System.IO.File
            Dim FileName As String

            FileName = BankFiledir & "Kyriba.csv"
