Public Class FrmPrSsDutyHours

    Dim tPrSsDutyHours As New cPrSsDutyHours
    Dim DG1Changing As Boolean = False
    Private Sub frmPrSsDutyHours_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Top = 0
        Me.Left = 0
        Initialize()
        ...
        If Flag Then
            If Me.txtCode.Text <> "" Then
                If Not Me.txtCode.ReadOnly Then
                    Dim tPrSsDutyHours As New cPrSsDutyHours(Trim(Me.txtCode.Text))
                    If tPrSsDutyHours.Code <> "" Then
                        MsgBox("Duty Hour already exists - Record cannot be inserted", MsgBoxStyle.Critical)
                        Flag = False
                    End If
                End If
            End If
    ...
    Private Sub TSBNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSBNew.Click
        ...
        tPrSsDutyHours = New cPrSsDutyHours
        ClearMe()
        ClearErrors()
    ...
    End Sub
    '
    Private Sub LoadPrSsDutyHours(ByVal tCode As String)
        tPrSsDutyHours = New cPrSsDutyHours(tCode)
        If tPrSsDutyHours.Code <> "" Then
            With tPrSsDutyHours
    ...
    Private Sub TSBDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TSBDelete.Click
        ...
        If Response = 1 Then
            If tPrSsDutyHours.Delete(Trim(Me.txtCode.Text)) Then
