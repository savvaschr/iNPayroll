Public Class FrmPrSsSectorPay

    Dim tPrSsSectorPay As New cPrSsSectorPay
    Dim DG1Changing As Boolean = False
    Private Sub frmPrSsSectorPay_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Top = 0
        Me.Left = 0
        Initialize()
        ...
        If Flag Then
            If Me.txtCode.Text <> "" Then
                If Not Me.txtCode.ReadOnly Then
                    Dim tPrSsSectorPay As New cPrSsSectorPay(Trim(Me.txtCode.Text))
                    If tPrSsSectorPay.Code <> "" Then
                        MsgBox("Sector Pay already exists - Record cannot be inserted", MsgBoxStyle.Critical)
                        Flag = False
                    End If
                End If
            End If
    ...
    Private Sub TSBNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSBNew.Click
        ...
        tPrSsSectorPay = New cPrSsSectorPay
        ClearMe()
        ClearErrors()
    ...
    End Sub
    '
    Private Sub LoadPrSsSectorPay(ByVal tCode As String)
        tPrSsSectorPay = New cPrSsSectorPay(tCode)
        If tPrSsSectorPay.Code <> "" Then
            With tPrSsSectorPay
    ...
    Private Sub TSBDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TSBDelete.Click
        ...
        If Response = 1 Then
            If tPrSsSectorPay.Delete(Trim(Me.txtCode.Text)) Then
