Public Class frmPrSsPayrollTypes
    Dim tPrSsPayrollTypes As New cPrSsPayrollTypes
    Dim DG1Changing As Boolean = False
    Private Sub frmPrSsPayrollTypes_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Top = 0
        Me.Left = 0
        Initialize()
        ...
        If Flag Then
            If Me.txtCode.Text <> "" Then
                If Not Me.txtCode.ReadOnly Then
                    Dim tPrSsPayrollTypes As New cPrSsPayrollTypes(Trim(Me.txtCode.Text))
                    If tPrSsPayrollTypes.Code <> "" Then
                        MsgBox("Payroll Type already exists - Record can not be inserted", MsgBoxStyle.Critical)
                        Flag = False
                    End If
                End If
            End If
    ...
    Private Sub TSBNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSBNew.Click
        ...
        tPrSsPayrollTypes = New cPrSsPayrollTypes
        ClearMe()
        ClearErrors()
    ...
    End Sub
    '
    Private Sub LoadPrSsPayrollTypes(ByVal tCode As String)
        tPrSsPayrollTypes = New cPrSsPayrollTypes(tCode)
        If tPrSsPayrollTypes.Code <> "" Then
            With tPrSsPayrollTypes
    ...
    Private Sub TSBDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TSBDelete.Click
        ...
        If Response = 1 Then
            If tPrSsPayrollTypes.Delete(Trim(Me.txtCode.Text)) Then
