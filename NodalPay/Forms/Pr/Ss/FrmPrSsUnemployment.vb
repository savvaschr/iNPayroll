Public Class FrmPrSsUnemployment
    Dim tPrSsUnemployment As New cPrSsUnemployment
    Dim DG1Changing As Boolean = False
    Private Sub frmPrSsUnemployment_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Top = 0
        Me.Left = 0
        Initialize()
        ...
        If Flag Then
            If Me.txtCode.Text <> "" Then
                If Not Me.txtCode.ReadOnly Then
                    Dim tPrSsUnemployment As New cPrSsUnemployment(Trim(Me.txtCode.Text))
                    If tPrSsUnemployment.Code <> "" Then
                        MsgBox("Unemployment Code already exists - Record cannot be inserted", MsgBoxStyle.Critical)
                        Flag = False
                    End If
                End If
            End If
    ...
    Private Sub TSBNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSBNew.Click
        ...
        tPrSsUnemployment = New cPrSsUnemployment
        ClearMe()
        ClearErrors()
    ...
    End Sub
    '
    Private Sub LoadPrSsUnemployment(ByVal tCode As String)
        tPrSsUnemployment = New cPrSsUnemployment(tCode)
        If tPrSsUnemployment.Code <> "" Then
            With tPrSsUnemployment
    ...
    Private Sub TSBDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TSBDelete.Click
        ...
        If Response = 1 Then
            If tPrSsUnemployment.Delete(Trim(Me.txtCode.Text)) Then
