Public Class frmPrMsEarningCodes
    Dim tPrMsEarningCodes As New cPrMsEarningCodes
    Dim DG1Changing As Boolean = False
    Private Sub frmPrMsEarningCodes_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Top = 0
        Me.Left = 0
        Initialize()
        ...
        If Flag Then
            If Me.txtCode.Text <> "" Then
                If Not Me.txtCode.ReadOnly Then
                    Dim tPrMsEarningCodes As New cPrMsEarningCodes(Trim(Me.txtCode.Text))
                    If tPrMsEarningCodes.Code <> "" Then
                        MsgBox("Earning Code already exists - Record cannot be inserted", MsgBoxStyle.Critical)
                        Flag = False
                    End If
                End If
            End If
    ...
    Private Sub ClearMe()
        Me.txtCode.Text = ""
        Try
            Me.cmbErnTypCode.SelectedIndex = 0
    ...
    Private Sub LoadCombos()
        LoadPrSsEarningTypes()
    End Sub
    '
    Private Sub LoadPrSsEarningTypes()
        Dim ds As DataSet
        Dim i As Integer
        ds = Global1.Business.AG_GetAllPrSsEarningTypes()
        If CheckDataSet(ds) Then
            Dim tPrSsEarningTypes As New cPrSsEarningTypes
            With Me.cmbErnTypCode
                .BeginUpdate()
                .Items.Clear()
                For i = 0 To ds.Tables(0).Rows.Count - 1
                    tPrSsEarningTypes = New cPrSsEarningTypes(DbNullToString(ds.Tables(0).Rows(i).Item(0)))
                    .Items.Add(tPrSsEarningTypes)
                Next i
                .ValueMember = "ErnTyp_Code"
                .SelectedIndex = 0
                .EndUpdate()
            End With
        End If
    ...
    Private Sub ClearErrors()
        ...
        Me.ErrErnTypCode.SetError(Me.cmbErnTypCode, "")
    ...
    Private Sub TSBNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSBNew.Click
        ...
        tPrMsEarningCodes = New cPrMsEarningCodes
        ClearMe()
        ClearErrors()
    ...
    Private Sub TryToSave()
        If ValidateMe() Then
            ...
            Try
                ...
                '       Update = False
                '  End If
                With tPrMsEarningCodes
                    .Code = CStr(Me.txtCode.Text)
                    .ErnTypCode = CType(Me.cmbErnTypCode.SelectedItem, cPrSsEarningTypes).Code
    ...
    End Sub
    '
    Private Sub LoadPrMsEarningCodes(ByVal tCode As String)
        tPrMsEarningCodes = New cPrMsEarningCodes(tCode)
        If tPrMsEarningCodes.Code <> "" Then
            With tPrMsEarningCodes
                ...
                Dim ErnTypCode As New cPrSsEarningTypes(.ErnTypCode)
                Me.cmbErnTypCode.SelectedIndex = Me.cmbErnTypCode.FindStringExact(ErnTypCode.ToString)
    ...
    Private Sub TSBDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TSBDelete.Click
        ...
        If Response = 1 Then
            If tPrMsEarningCodes.Delete(Trim(Me.txtCode.Text)) Then
    ...
    Private Sub LoadDataFromDG1(ByVal i As Integer)
        ...
        If Me.DG1.RowCount > 0 Then
            ...
            Me.cmbErnTypCode.SelectedIndex = cmbErnTypCode.FindStringExact(Trim(CStr(DG1.Item(1, i).Value)))
            Me.txtDescriptionL.Text = DbNullToString(DG1.Item(2, i).Value)
            Me.txtDescriptionS.Text = DbNullToString(DG1.Item(3, i).Value)

            Dim ErnTypCode As New cPrSsEarningTypes(Trim(CStr(DG1.Item(1, i).Value)))
            Me.cmbErnTypCode.SelectedIndex = Me.cmbErnTypCode.FindStringExact(ErnTypCode.ToString)
