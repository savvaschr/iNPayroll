Public Class FrmPrMsInterfaceTemplate
    Dim tPrMsInterfaceTemplate As New cPrMsInterfaceTemplate
    Dim DG1Changing As Boolean = False
    Private Sub frmPrMsInterfaceTemplate_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Top = 0
        Me.Left = 0
        Initialize()
    ...
    Private Sub TSBNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSBNew.Click
        ...
        tPrMsInterfaceTemplate = New cPrMsInterfaceTemplate
        ClearMe()
        ClearErrors()
    ...
    Private Sub TryToSave()
        If ValidateMe() Then
            ...
            Try
                ...
                '       Update = False
                '  End If
                With tPrMsInterfaceTemplate
                    .IntTemCode = CStr(Me.txtCode.Text)
                    .TemGrpCode = CType(Me.cmbTemGrp.SelectedItem, cPrMsTemplateGroup).Code
                    .IntTemDescription = CStr(Me.txtDescriptionL.Text)
                    If .Save() Then
    ...
    Private Sub LoadPrMsInterfaceTemplate(ByVal tCode As String)
        tPrMsInterfaceTemplate = New cPrMsInterfaceTemplate(tCode)
        If tPrMsInterfaceTemplate.IntTemCode <> "" Then
            With tPrMsInterfaceTemplate
                Me.txtCode.ReadOnly = True
                Me.txtCode.BackColor = SystemColors.Info
                Me.txtCode.Text = CStr(.IntTemCode)
                ' Need to decide what to do with a combo in the load sub Property = PayTypCode
                Me.txtDescriptionL.Text = CStr(.IntTemDescription)
                Dim TemGrp As New cPrMsTemplateGroup(.TemGrpCode)
    ...
    Private Sub FillDG1()
        Dim ds As DataSet
        ds = Global1.Business.GetAllPrMsinterfaceTemplate
        DG1Changing = True
