        ...
        If UCase(Global1.UserName) = "SA" Or UCase(Global1.UserName) = "NODAL" Or UCase(Global1.UserName) = "INSOFT" Then
            ...
            If C.Id <> 0 Then
                ...
                If Ans = MsgBoxResult.Yes Then
                    ...
                    Dim TF As Boolean
                    TF = C.CheckForDeletion
                    If Not TF Then
                        Ans2 = MsgBox("There are Transactions on this Company, Delete them ?", vbYesNoCancel)
                        If Ans = MsgBoxResult.Yes Then
                            TF = True
                        End If
                    End If
            ...
            End If
        Else
            MsgBox("You are not allowed to perform this action", MsgBoxStyle.Information)
        End If
    End Sub
