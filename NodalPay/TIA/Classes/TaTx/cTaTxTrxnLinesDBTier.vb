Public Class cTaTxTrxnLinesDBTier
    Inherits cDataTier
    ...
    End Function
    Protected Function Save(ByRef _cTrxnLin As cTaTxTrxnLines) As Boolean
        ...
        End With
        If Me.StoredProcedure("TaTxTrxnLines_Save_Update", SpParams, SpNames, 16) Then
        ...
        End If
    End Function
    Public Function Delete(ByVal _cTrxnLin As cTaTxTrxnLines) As Boolean
        Dim Str As String
        Dim i As Integer
        Str = "DELETE FROM TaTxTrxnLines WHERE TrxLin_id=" & _cTrxnLin.Id
